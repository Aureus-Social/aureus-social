...
// ═══════ LANGUES NL / EN / DE ═══════
// Clone complet de FR (articles inclus), puis overrides spécifiques par langue
['nl','en','de'].forEach(l=>{ T[l]=JSON.parse(JSON.stringify(T.fr)); });

// ── NL ──
Object.assign(T.nl,{
  topbar:{country:'🇧🇪 België',bce:'KBO BE 1028.230.781',contact:'Contact',client:'Klantenzone'},
...
// ── EN ──
Object.assign(T.en,{
  topbar:{country:'🇧🇪 Belgium',bce:'VAT BE 1028.230.781',contact:'Contact',client:'Client area'},
...
// ── DE ──
Object.assign(T.de,{
  topbar:{country:'🇧🇪 Belgien',bce:'USt BE 1028.230.781',contact:'Kontakt',client:'Kundenbereich'},
...
// ── EN — pages internes ──
T.en.ind={...T.fr.ind,ey:'Freelancers',bc:'Freelancers',h:'Become a freelancer\nin Belgium.',sub:'The complete step-by-step guide.',c1:'Talk to an expert',c2:'Book a demo',card:{...T.fr.ind.card,label:'Aureus Social Pro',title:'Your social back-office',sub:'Automate your obligations.'},sy:{...T.fr.ind.sy,ey:'Step-by-step guide',h:'Start in 6 steps',chkH:'What Aureus automates',tip:{h:'Good to know',t:'In 2026, the first employee benefits from a full exemption from employer ONSS contributions for 5 years.'}},faq:{ey:'FAQ',h:'Everything you want to know',items:[["What is the registration deadline?","90 days from the start of your activity. If exceeded: compulsory registration and surcharges."],["How much are contributions in 2026?","20.5% up to 72,810 and 14.16% above. Minimum: 870.78/quarter."],["Can I be a supplementary freelancer?","Yes, subject to your employer's agreement. Reduced contributions under the supplementary regime."],["Does Aureus manage company directors?","Yes. Natural persons and company mandataries (SRL managers, SA directors)."]]},cta:{h:"Ready to start with confidence?",sub:"Our experts guide you from A to Z.",btn:"Talk to an expert →"}};
T.en.emp={...T.fr.emp,ey:'First employee',bc:'Become an employer',h:'Hire your first\nemployee\nwith confidence.',sub:'ONSS registration, contract, Dimona, first payroll.',c1:'Book a demo',c2:'Already an employer →',card:{...T.fr.emp.card,label:'First employee in Belgium',title:'What Aureus does',sub:'Full automation of the social cycle.'},steps:{...T.fr.emp.steps,ey:'Key steps',h:'From 0 to your first employee'},av:{...T.fr.emp.av,ey:'2026 Benefits',h:'Exemptions & hiring bonuses'},cta:{h:"Hire your first employee tomorrow.",sub:'Free demo · Full support · First month free',btn:'Get started →'}};
T.en.emps={...T.fr.emps,ey:'Employers',bc:'Employers',h:'Your payroll,\nyour declarations,\nautomated.',sub:'166 joint committees, DmfA XML, Belcotax, WinBooks/BOB export — 132 modules.',c1:'Access platform',c2:'Book a demo',card:{...T.fr.emps.card,label:'Platform in production',title:'Real figures — March 2026',sub:'132 modules · 44,246 lines of code'},mods:{...T.fr.emps.mods,ey:'Features',h:'132 modules for the complete social cycle'},cta:{h:"See the platform in action.",sub:'Demo on your own data — 30 minutes.',btn:'Book a demo →'}};
T.en.exp={...T.fr.exp,ey:'Accountants',bc:'Accountants',h:'One portal,\nall your social\nfiles.',sub:'Mahis/CSAM mandates, multi-client portal, REST API, migration from SD Worx or Partena.',c1:'Book a fiduciary demo',c2:'Assisted migration',card:{...T.fr.exp.card,label:'Fiduciary Plan',title:'Unlimited multi-files',sub:'Portal · API · SLA · Migration'},it:{...T.fr.exp.it,ey:'What we offer',h:'Designed for financial professionals'},mig:{...T.fr.exp.mig,ey:'Migration',h:'Leave SD Worx or Partena without risk.'},cta:{h:"Join the firms that chose independence.",sub:'Assisted migration · SLA 99.9% · First month free',btn:'Fiduciary demo →'}};
T.en.form={...T.fr.form,ey:'Training',bc:'Training',h:'Master Belgian\nsocial law.\nAt your pace.',sub:'Webinars, practical guides and tutorials on Belgian payroll, ONSS, Dimona and Belcotax.',c1:'See programme',c2:'Contact us',card:{...T.fr.form.card,label:'Aureus Training',title:'Learn from experts',sub:'Content based on real case studies.'},mods:{...T.fr.form.mods,ey:'Topics',h:'Our 6 training modules'},arts:{...T.fr.form.arts,ey:'Inspiration',h:'Always ready for the future'},cta:{h:"Starting a business or looking to grow?",sub:'Whatever your question, Aureus gives you clear answers.',btn:'Contact us →'}};
T.en.con={...T.fr.con,ey:'Contact',h:'How can we\nhelp you?',sub:'Our team responds within 4 working hours. No chatbot — real Belgian social law experts.',ch:[['✉️','Email','info@aureus-ia.com'],['💻','Application','app.aureussocial.be'],['📍','Address','Place Marcel Broodthaers 8, 1060 Saint-Gilles, Brussels']],cr:[['VAT','BE 1028.230.781'],['Mahis','DGIII/MAHI011'],['Peppol','0208:1028230781'],['Response','< 4 working hours']],f:{t:'Book a demo',s:'Response guaranteed within 4 working hours.',fn:'First name *',ln:'Last name *',em:'Professional email *',co:'Company',ro:'You are *',ms:'Message',fnp:'John',lnp:'Smith',emp:'john.smith@fiduciary.com',cop:'Smith & Partners',msp:'Describe your situation…',sub:'Send request',note:'By submitting this form you agree to our GDPR policy.',ok:'Message sent — we will reply within 4 working hours.',roles:['Select...','Freelancer / Starter','Fiduciary / Accountant','Direct employer','Social secretariat','Broker / Partner','Other']}};

// ── DE — pages internes ──
T.de.ind={...T.fr.ind,ey:'Selbständige',bc:'Selbständige',h:'Selbständig werden\nin Belgien.',sub:'Der vollständige Schritt-für-Schritt-Leitfaden.',c1:'Mit einem Experten sprechen',c2:'Demo anfordern',card:{...T.fr.ind.card,label:'Aureus Social Pro',title:'Ihr soziales Back-Office',sub:'Automatisieren Sie Ihre Pflichten.'},sy:{...T.fr.ind.sy,ey:'Schritt für Schritt',h:'In 6 Schritten starten',chkH:'Was Aureus automatisiert',tip:{h:'Gut zu wissen',t:'Im Jahr 2026 profitiert der erste Arbeitnehmer 5 Jahre lang von einer vollständigen Befreiung der Arbeitgeberbeiträge.'}},faq:{ey:'Häufige Fragen',h:'Alles, was Sie wissen möchten',items:[["Was ist die Anmeldefrist?","90 Tage ab Beginn Ihrer Tätigkeit. Bei Überschreitung: Zwangsanmeldung und Zuschläge."],["Wie hoch sind die Beiträge 2026?","20,5% bis 72.810 und 14,16% darüber. Minimum: 870,78/Quartal."],["Kann ich nebenberuflich selbständig sein?","Ja, vorbehaltlich der Zustimmung Ihres Arbeitgebers."],["Verwaltet Aureus Gesellschaftsgeschäftsführer?","Ja. Natürliche Personen und Gesellschaftsmandatare (SRL, SA)."]]},cta:{h:"Bereit, sicher zu starten?",sub:"Unsere Experten begleiten Sie von A bis Z.",btn:"Mit einem Experten sprechen →"}};
T.de.emp={...T.fr.emp,ey:'Erster Arbeitnehmer',bc:'Arbeitgeber werden',h:'Ihren ersten Mitarbeiter\nmit Vertrauen\neinstellen.',sub:'ONSS-Anmeldung, Vertrag, Dimona, erste Gehälter.',c1:'Demo anfordern',c2:'Bereits Arbeitgeber →',card:{...T.fr.emp.card,label:'Erster Arbeitnehmer in Belgien',title:'Was Aureus tut',sub:'Vollständige Automatisierung des Sozialdatenzyklus.'},steps:{...T.fr.emp.steps,ey:'Wichtigste Schritte',h:'Von 0 zu Ihrem ersten Mitarbeiter'},av:{...T.fr.emp.av,ey:'Vorteile 2026',h:'Befreiungen & Einstellungsprämien'},cta:{h:"Stellen Sie morgen Ihren ersten Mitarbeiter ein.",sub:'Kostenlose Demo · Vollständige Begleitung · Erster Monat gratis',btn:'Starten →'}};
T.de.emps={...T.fr.emps,ey:'Arbeitgeber',bc:'Arbeitgeber',h:'Ihre Gehaltsabrechnung,\nIhre Meldungen,\nautomatisiert.',sub:'166 paritätische Kommissionen, DmfA XML, Belcotax, WinBooks/BOB Export — 132 Module.',c1:'Zur Plattform',c2:'Demo anfordern',card:{...T.fr.emps.card,label:'Plattform in Produktion',title:'Echte Zahlen — März 2026',sub:'132 Module · 44.246 Codezeilen'},mods:{...T.fr.emps.mods,ey:'Funktionen',h:'132 Module für den vollständigen Sozialdatenzyklus'},cta:{h:"Sehen Sie die Plattform in Aktion.",sub:'Demo mit Ihren eigenen Daten — 30 Minuten.',btn:'Eine Demo reservieren →'}};
T.de.exp={...T.fr.exp,ey:'Buchhalter',bc:'Buchhalter',h:'Ein Portal,\nalle sozialen\nAkten.',sub:'Mahis/CSAM-Mandate, Multi-Mandanten-Portal, REST API, Migration von SD Worx oder Partena.',c1:'Fiduziaire Demo anfordern',c2:'Begleitete Migration',card:{...T.fr.exp.card,label:'Fiduziaire Plan',title:'Unbegrenzte Multi-Akten',sub:'Portal · API · SLA · Migration'},it:{...T.fr.exp.it,ey:'Was wir bieten',h:'Für Finanzfachleute konzipiert'},mig:{...T.fr.exp.mig,ey:'Migration',h:'SD Worx oder Partena risikofrei verlassen.'},cta:{h:"Schließen Sie sich den Kanzleien an, die Unabhängigkeit gewählt haben.",sub:'Begleitete Migration · SLA 99.9% · Erster Monat gratis',btn:'Fiduziaire Demo →'}};
T.de.form={...T.fr.form,ey:'Schulungen',bc:'Schulungen',h:'Das belgische Sozialrecht\nmeistern.\nIn Ihrem Tempo.',sub:'Webinare, Praxisleitfäden und Tutorials zur belgischen Lohnberechnung, ONSS, Dimona und Belcotax.',c1:'Programm ansehen',c2:'Kontakt aufnehmen',card:{...T.fr.form.card,label:'Aureus Schulungen',title:'Von Experten lernen',sub:'Inhalte aus echten Praxisfällen.'},mods:{...T.fr.form.mods,ey:'Themen',h:'Unsere 6 Schulungsmodule'},arts:{...T.fr.form.arts,ey:'Inspiration',h:'Immer bereit für die Zukunft'},cta:{h:"Gründen Sie eine Tätigkeit oder möchten Sie Ihr Unternehmen ausbauen?",sub:'Was auch immer Ihre Frage ist, Aureus gibt Ihnen klare Antworten.',btn:'Kontakt aufnehmen →'}};
T.de.con={...T.fr.con,ey:'Kontakt',h:'Wie können wir\nIhnen helfen?',sub:'Unser Team antwortet innerhalb von 4 Arbeitsstunden. Kein Chatbot — echte Experten.',ch:[['✉️','E-Mail','info@aureus-ia.com'],['💻','Anwendung','app.aureussocial.be'],['📍','Adresse','Place Marcel Broodthaers 8, 1060 Saint-Gilles, Brüssel']],cr:[['USt','BE 1028.230.781'],['Mahis','DGIII/MAHI011'],['Peppol','0208:1028230781'],['Antwort','< 4 Arbeitsstunden']],f:{t:'Demo anfordern',s:'Antwort garantiert innerhalb von 4 Arbeitsstunden.',fn:'Vorname *',ln:'Nachname *',em:'Geschäftliche E-Mail *',co:'Unternehmen',ro:'Sie sind *',ms:'Nachricht',fnp:'Max',lnp:'Müller',emp:'max.mueller@kanzlei.de',cop:'Kanzlei Müller & Partner',msp:'Beschreiben Sie Ihre Situation…',sub:'Anfrage senden',note:'Mit dem Absenden stimmen Sie unserer DSGVO-Richtlinie zu.',ok:'Nachricht gesendet — wir antworten innerhalb von 4 Arbeitsstunden.',roles:['Auswählen...','Selbständig / Starter','Fiduziaire / Buchhalter','Direkter Arbeitgeber','Sozialsekretariat','Makler / Partner','Andere']}};
