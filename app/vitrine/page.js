...
T.nl={
  ...
  art:{ey:'Altijd klaar voor de toekomst',h:'Bronnen & nieuws',filters:[['tout','Alles'],['paie','Loon'],['rh','HR'],['legal','Wetgeving'],['onss','ONSS']],items:T.fr.art.items},
  ...
  exp:{ey:'Accountants',bc:'Accountants',h:'\u00c9\u00e9n portaal,\nalle sociale\ndossiers.',sub:'Mahis/CSAM mandaten, multi-klant portaal, REST API, migratie van SD Worx of Partena.',c1:'Fiduciaire demo aanvragen',c2:'Begeleide migratie',
    ...
    it:{ey:'Wat wij bieden',h:'Ontworpen voor cijferprofessionals',items:T.fr.exp.it.items},
    mig:{ey:'Migratie',h:'SD Worx of Partena zonder risico verlaten.',items:T.fr.exp.mig.items},
  ...
  form:{ey:'Opleidingen',bc:'Opleidingen',h:'Het Belgische sociale recht\nbeheersen.\nIn uw tempo.',sub:'Webinars, praktijkgidsen en tutorials over Belgische loonberekening, ONSS, Dimona en Belcotax.',c1:'Programma bekijken',c2:'Contact opnemen',
    ...
    arts:{ey:'Inspiratie',h:'Altijd klaar voor de toekomst',items:T.fr.form.arts.items},
...
T.en={
  ...
  art:{ey:'Always ready for the future',h:'Resources & news',filters:[['tout','All'],['paie','Payroll'],['rh','HR'],['legal','Legislation'],['onss','ONSS']],items:T.fr.art.items},
  ...
  exp:{ey:'Accountants',bc:'Accountants',h:'One portal,\nall your social\nfiles.',sub:'Mahis/CSAM mandates, multi-client portal, REST API, migration from SD Worx or Partena.',c1:'Book a fiduciary demo',c2:'Assisted migration',
    ...
    it:{ey:'What we offer',h:'Designed for financial professionals',items:T.fr.exp.it.items},
    mig:{ey:'Migration',h:'Leave SD Worx or Partena without risk.',items:T.fr.exp.mig.items},
  ...
  form:{ey:'Training',bc:'Training',h:'Master Belgian\nsocial law.\nAt your pace.',sub:'Webinars, practical guides and tutorials on Belgian payroll, ONSS, Dimona and Belcotax.',c1:'See programme',c2:'Contact us',
    ...
    arts:{ey:'Inspiration',h:'Always ready for the future',items:T.fr.form.arts.items},
...
T.de={
  ...
  art:{ey:'Immer bereit f\u00fcr die Zukunft',h:'Ressourcen & News',filters:[['tout','Alles'],['paie','Lohn'],['rh','HR'],['legal','Gesetzgebung'],['onss','ONSS']],items:T.fr.art.items},
  ...
  ft:{col1:'L\u00f6sungen',col2:'Produkt',col3:'Rechtliches',copy:'\u00a9 2026 Aureus IA SPRL \u00b7 Alle Rechte vorbehalten',desc:'Digitales belgisches Sozialsekretariat. 132 Module, 166 Kommissionen.',c1:[['Selbst\u00e4ndige','independant'],['Arbeitgeber werden','employeur'],['Arbeitgeber','employeurs'],['Buchhalter','experts'],['Schulungen','formations']],c2:[['Demo anfordern','contact'],['Dokumentation',null],['Status',null]],c3:[['Datenschutz',null],['AGB',null],['DSGVO',null],['Disclaimer',null]]},
  articles:T.fr.articles,
  ...
  exp:{ey:'Buchhalter',bc:'Buchhalter',h:'Ein Portal,\nalle sozialen\nAkten.',sub:'Mahis/CSAM-Mandate, Multi-Mandanten-Portal, REST API, Migration von SD Worx oder Partena.',c1:'Fiduziaire Demo anfordern',c2:'Begleitete Migration',
    ...
    it:{ey:'Was wir bieten',h:'F\u00fcr Finanzfachleute konzipiert',items:T.fr.exp.it.items},
    mig:{ey:'Migration',h:'SD Worx oder Partena risikofrei verlassen.',items:T.fr.exp.mig.items},
  ...
  form:{ey:'Schulungen',bc:'Schulungen',h:'Das belgische Sozialrecht\nmeistern.\nIn Ihrem Tempo.',sub:'Webinare, Praxisleitf\u00e4den und Tutorials zur belgischen Lohnberechnung, ONSS, Dimona und Belcotax.',c1:'Programm ansehen',c2:'Kontakt aufnehmen',
    ...
    arts:{ey:'Inspiration',h:'Immer bereit f\u00fcr die Zukunft',items:T.fr.form.arts.items},
