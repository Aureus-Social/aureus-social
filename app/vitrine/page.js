...
T.nl={
  ...
  emp:{ey:'Eerste werknemer',bc:'Werkgever worden',h:'Uw eerste medewerker\nin vertrouwen\naannemen.',sub:'ONSS-inschrijving, contract, Dimona, eerste lonen.',c1:'Demo aanvragen',c2:'Al werkgever \u2192',
    ...
    av:{ey:'Voordelen 2026',h:'Vrijstellingen & aanwervingspremies',items:[['🎁','Vrijstelling 1e werknemer','Volledige vrijstelling van patronale ONSS-bijdragen gedurende 5 jaar.','Door uw eerste werknemer aan te werven, geniet u van een volledige vrijstelling van werkgevers-ONSS-bijdragen voor de volledige duur van dat dienstverband. Aureus berekent de vrijstelling automatisch.'],['💼','Activa.brussels','Maandelijkse premie tot 350 € voor een Brusselse werkzoekende.','Activa.brussels is een Brusselse activeringstoeslag. De werkgever ontvangt tot 350 per maand gedurende 12 tot 30 maanden. Aureus volgt automatisch de premies en MonBEE-deadlines op.'],['📉','Lageloonvermindering','Patronale ONSS-vermindering voor lonen onder 3.100 €/maand.','De structurele loonlastenvermindering is een vermindering van werkgevers-ONSS-bijdragen voor werknemers met lager loon. Aureus past de formule automatisch toe.'],['🎓','SINE & Activa-plan','Verminderingen voor aanwerving van personen ver van de arbeidsmarkt.','Het SINE-plan en het Activa-plan maken het mogelijk om personen die ver van de arbeidsmarkt staan in dienst te nemen met belangrijke ONSS-kortingen. Aureus controleert automatisch de geschiktheid.'],['👶','Ouderschapsverlof','Beheer van schorsingen van het contract en specifieke ONSS-aangiften.','Ouderschapsverlof stelt een werknemer in staat zijn contract op te schorten voor een kind jonger dan 12 jaar. Aureus beheert de ONSS-codes 70, 71, 72 en de impact op het gewaarborgd loon.'],['📋','MonBEE aanwerving','Aanwervingspremie via MonBEE. Termijnen en documenten automatisch gegenereerd.','MonBEE centraliseert de aanwervingspremies in Brussel. De aanvraag moet binnen 30 dagen na indiensttreding worden ingediend. Aureus genereert automatisch een herinnering 5 dagen voor de deadline.']]},
...
T.en={
  ...
  emp:{ey:'First employee',bc:'Become an employer',h:'Hire your first\nemployee\nwith confidence.',sub:'ONSS registration, contract, Dimona, first payroll.',c1:'Book a demo',c2:'Already an employer \u2192',
    ...
    av:{ey:'2026 Benefits',h:'Exemptions & hiring bonuses',items:[['🎁','1st employee exemption','Full exemption from employer ONSS contributions for 5 years.','By hiring your first employee, you benefit from a full exemption from employer ONSS contributions for the entire duration of that employment. Aureus calculates the exemption automatically.'],['💼','Activa.brussels','Monthly subsidy up to €350 for a Brussels jobseeker.','Activa.brussels is a Brussels employment activation bonus. The employer receives up to 350 per month for 12 to 30 months. Aureus automatically tracks bonuses and MonBEE deadlines.'],['📉','Low wage reduction','Employer ONSS reduction for salaries below €3,100/month.','The structural low-wage reduction reduces employer ONSS contributions for workers with lower wages. Aureus automatically applies the ONSS formula in DmfA calculations.'],['🎓','SINE & Activa plan','Reductions for hiring people far from the labour market.','The SINE plan and Activa plan allow hiring people far from the labour market with significant ONSS reductions. Aureus automatically checks eligibility.'],['👶','Parental leave','Management of contract suspensions and specific ONSS declarations.','Parental leave allows a worker to suspend their contract for a child under 12 years old. Aureus manages ONSS codes 70, 71, 72 and the impact on guaranteed salary calculation.'],['📋','MonBEE recruitment','Hiring subsidy via MonBEE. Deadlines and documents generated automatically.','MonBEE centralises hiring bonuses in Brussels. Applications must be submitted within 30 days of hiring. Aureus generates a reminder 5 days before the deadline.']]},
...
T.de={
  ...
  emp:{ey:'Erster Arbeitnehmer',bc:'Arbeitgeber werden',h:'Ihren ersten Mitarbeiter\nmit Vertrauen\neinstellen.',sub:'ONSS-Anmeldung, Vertrag, Dimona, erste Geh\u00e4lter.',c1:'Demo anfordern',c2:'Bereits Arbeitgeber \u2192',
    ...
    av:{ey:'Vorteile 2026',h:'Befreiungen & Einstellungsprämien',items:[['🎁','Befreiung 1. Arbeitnehmer','Vollständige Befreiung von ONSS-Arbeitgeberbeiträgen für 5 Jahre.','Durch die Einstellung Ihres ersten Arbeitnehmers profitieren Sie von vollständiger Befreiung von ONSS-Beiträgen. Aureus berechnet die Befreiung automatisch.'],['💼','Activa.brussels','Monatliche Prämie bis zu 350 € für einen Brüsseler Arbeitssuchenden.','Activa.brussels ist eine Brüsseler Beschäftigungsaktivierungsbeihilfe. Der Arbeitgeber erhält bis zu 350 pro Monat für 12 bis 30 Monate. Aureus verfolgt automatisch die Prämien und Fristen.'],['📉','Niedriglohnermäßigung','ONSS-Arbeitgeberermäßigung für Löhne unter 3.100 €/Monat.','Die strukturelle Niedriglohnermäßigung reduziert Arbeitgeber-ONSS-Beiträge für Arbeitnehmer mit niedrigeren Löhnen. Aureus wendet die Formel automatisch an.'],['🎓','SINE & Activa-Plan','Ermäßigungen für die Einstellung von arbeitsmarktfernen Personen.','Der SINE-Plan und der Activa-Plan ermöglichen die Einstellung arbeitsmarktferner Personen mit ONSS-Ermäßigungen. Aureus prüft die Berechtigung automatisch.'],['👶','Elternzeit','Verwaltung von Vertragsunterbrechungen und spezifischen ONSS-Erklärungen.','Elternzeit ermöglicht es einem Arbeitnehmer, seinen Vertrag für ein Kind unter 12 Jahren auszusetzen. Aureus verwaltet die ONSS-Codes 70, 71, 72 automatisch.'],['📋','MonBEE Einstellung','Einstellungsprämie über MonBEE. Fristen und Dokumente automatisch generiert.','MonBEE zentralisiert die Einstellungsprämien in Brüssel. Der Antrag muss innerhalb von 30 Tagen eingereicht werden. Aureus generiert automatisch eine Erinnerung 5 Tage vor der Frist.']]},
...
function PageEmp({t,go,goBack}) {
  ...
  return(<>
    <section style={{background:CREAM,padding:'60px 0 64px',borderBottom:`1px solid ${BORDER}`}}><div className="vt-wrap"><div className="phg"><div>
      ...
      <h1 style={{marginBottom:18,whiteSpace:'pre-line'}}>{d.h.split('\n').map((l,i)=>(<span key={i}>{i>0&&<br/>}{i===2?<em>{l}</em>:l}</span>))}</h1>
      <p style={{fontSize:18,color:STONE,marginBottom:28,fontWeight:300}}>{d.sub}</p>
      <div style={{display:'flex',gap:12,flexWrap:'wrap',alignItems:'center'}}><button className="btn-p" onClick={()=>go('contact')}>{d.c1}</button><button className="btn-s" onClick={()=>go('employeurs')}>{d.c2}</button></div>
    ...
    <section className="vt-sec" style={{background:CREAM}}><div className="vt-wrap">
      <div style={{textAlign:'center',marginBottom:48}} className="fade-in">
        <div className="vt-ey">Ils nous ont fait confiance</div>
        <h2>Ce que disent nos premiers employeurs</h2>
      </div>
      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))',gap:20,maxWidth:900,margin:'0 auto'}}>
        {[
          {name:'Thomas V.',role:'Gérant — agence web, Bruxelles',text:"J'avais peur de la paperasse ONSS. En 2 jours, Aureus m'a guidé de l'immatriculation jusqu'à la première fiche de paie. Zéro stress.",stars:5},
          {name:'Sarah M.',role:'Fondatrice — startup RH, Gand',text:"La Dimona en 8 secondes, c'est réel. J'ai engagé 3 employés en 1 semaine sans aucune connaissance en droit social belge.",stars:5},
          {name:'Karim B.',role:'Indépendant complémentaire, Liège',text:"Passage de SD Worx à Aureus en 3 jours. Migration gratuite, toutes mes données reprises. Je paie 60% moins cher.",stars:5},
        ].map(({name,role,text,stars})=>(
          <div key={name} style={{background:WHITE,border:`1px solid ${BORDER}`,borderRadius:12,padding:'24px'}}>
            <div style={{color:GOLD,fontSize:14,marginBottom:12}}>{'★'.repeat(stars)}</div>
            <p style={{fontSize:14,color:STONE,lineHeight:1.7,marginBottom:16,fontStyle:'italic'}}>"{text}"</p>
            <div style={{fontWeight:700,fontSize:14,color:INK}}>{name}</div>
            <div style={{fontSize:12,color:MIST}}>{role}</div>
          </div>
        ))}
      </div>
    </div></section>
