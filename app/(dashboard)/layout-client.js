...
const ChomageTemporairePg = dynamic(() => import('../pages/ChomageTemporaire'), { ssr: false, loading: Loading });
const CalcMaladiePg = dynamic(() => import('../pages/CalcMaladie'), { ssr: false, loading: Loading });
const CoutsAnnuelsPg = dynamic(() => import('../pages/CoutsAnnuels'), { ssr: false, loading: Loading });
...
const ListingTVAPg = dynamic(() => import('../pages/ListingTVA'), { ssr: false, loading: Loading });
...
function DashboardLayoutApproved({ user }) {
  ...
  const renderPage = () => {
    ...
    switch (page) {
      ...
      case 'diagnostic': case 'diagnosticv': return <DiagnosticPage s={s} d={d} t={t} lang={lang} th={TH} />;
      case 'seuilssociaux': return <SeuilsPage s={s} d={d} t={t} lang={lang} th={TH} />;
      case 'onboarding': case 'onboardwizard': return <OnboardingPage s={s} d={d} t={t} lang={lang} th={TH} />;
      case 'cloture': return <CloturePage s={s} d={d} t={t} lang={lang} th={TH} />;
      case 'analytics': return <AnalyticsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'adminbaremes': return <AdminBaremesPageW s={s} d={d} t={t} lang={lang} th={TH} />;
      case 'auditsecuritecode': return <AuditCodePage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'optifiscale': case 'couttotal': return <PayrollSimPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'aureussuite': return <AureusIAPage s={s} d={d} t={t} lang={lang} th={TH} />;
      case 'dashrh': return <EmployeeHubPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      ...
      case 'facturationfiches': return <FacturationFichesPg state={s} dispatch={d} />;
      ...
      case 'listingtva': return <ListingTVAPg state={s} dispatch={d} />;
      case 'migrations': return <MigrationsAdminPg state={s} dispatch={d} />;
      ...
      case 'actionsrapides': return <SmartOpsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'journal': return <NotificationCenterPgW s={s} d={d} tab={page} />;
      case 'tbdirection': return <AnalyticsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      ...
      case 'rh': return <EmployeeHubPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      ...
      case 'creditemps': case 'credit_temps': return <CreditTempsPg state={s} dispatch={d} />;
      case 'subscriptions': case 'pricing': case 'plans': return <SubscriptionsPg state={s} dispatch={d} />;
      case 'chargessociales': return <ModsBatch2Pg s={s} d={d} tab={page} />;
      case 'chomagetemporaire': return <ChomageTemporairePg state={s} dispatch={d} />;
      ...
      case 'rapportce': return <AnalyticsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'rapports': return <AnalyticsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'rapportsrole': return <AnalyticsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'reporting': return <AnalyticsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'reportingpro': return <AnalyticsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'sepa': return <ModsBatch2Pg s={s} d={d} tab={page} />;
      case 'compteindividuelannuel': return <PayrollGroupPg s={s} d={d} tab={page} />;
      // CONCERTATION SOCIALE
      case 'ccts': return <LoisPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'delegations': return <LoisPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'delegationsyndicale': return <LoisPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'egalitehf': return <LoisPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'electionsociales': return <LoisPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'formationsec': return <LoisPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'lanceursalerte': return <LoisPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      ...
      // ADMINISTRATION
      case 'archives': return <SecurityPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'auditfiscale': return <AuditCodePage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'audittrail': return <AuditCodePage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'authroles': return <RolesPermissionsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'autoindex': return <PayrollGroupPg s={s} d={d} tab={page} />;
      case 'autopilot': return <SmartOpsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'cgvsaas': return <DocumentGeneratorPgW s={s} d={d} tab={page} />;
      case 'changelog': return <AdminPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'demodonnees': return <AdminPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'ged': return <SecurityPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'historique': return <AdminPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'integrations': return <AdminPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'massengine': return <ModsBatch2Pg s={s} d={d} tab={page} />;
      case 'mentionslegales': return <DocumentGeneratorPgW s={s} d={d} tab={page} />;
      case 'monitoring': return <AdminPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'piloteauto': return <SmartOpsPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'queue': return <ModsBatch2Pg s={s} d={d} tab={page} />;
      case 'rgpd': return <CompliancePage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
      case 'roadmapinfra': return <AdminPage s={s} d={d} t={t} lang={lang} th={TH} tab={page} />;
