...
export default function DashboardLayout({ user }) {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case 'calcmaladie': return <PayrollGroupPg s={s} d={d} />;
      case 'calendrier': return <PayrollGroupPg s={s} d={d} />;
      ...
      case 'simulateurspro': return <PayrollSimPage s={s} d={d} />;
      case 'simulicenciement': return <PayrollSimPage s={s} d={d} />;
      case 'simupension': return <PayrollSimPage s={s} d={d} />;
      case 'simutp': return <SimuNetBrutPage s={s} d={d} />;
      case 'soldetoutcompte': return <PayrollGroupPg s={s} d={d} />;
      case 'timeline': return <PayrollGroupPg s={s} d={d} />;
      case 'validation': return <PayrollGroupPg s={s} d={d} />;
      case 'vehiculesatn': return <PayrollGroupPg s={s} d={d} />;
      case 'comparateur': return <PayrollSimPage s={s} d={d} />;
      case 'compteIndividuel': return <PayrollGroupPg s={s} d={d} />;
      // DECLARATIONS & COMPTABILITE
      case 'batchdecl': return <ModsBatch2Pg s={s} d={d} />;
      case 'belcotax281': return <ModsBatch2Pg s={s} d={d} />;
      case 'bilansocial': return <AnalyticsPage s={s} d={d} />;
      case 'chargessociales': return <ModsBatch2Pg s={s} d={d} />;
      case 'chomagetemporaire': return <ModsBatch2Pg s={s} d={d} />;
      case 'exportWinbooks': return <ModsBatch2Pg s={s} d={d} />;
      case 'exportbatch': return <ModsBatch2Pg s={s} d={d} />;
      case 'exportcoda': return <ModsBatch2Pg s={s} d={d} />;
      case 'exportcompta': return <ModsBatch2Pg s={s} d={d} />;
      case 'exportcomptapro': return <ModsBatch2Pg s={s} d={d} />;
      case 'fiscal': return <TransversalCPPg s={s} d={d} />;
      case 'importcsv': return <ModsBatch2Pg s={s} d={d} />;
      case 'rapportce': return <AnalyticsPage s={s} d={d} />;
      case 'rapports': return <AnalyticsPage s={s} d={d} />;
      case 'rapportsrole': return <AnalyticsPage s={s} d={d} />;
      case 'reporting': return <AnalyticsPage s={s} d={d} />;
      case 'reportingpro': return <AnalyticsPage s={s} d={d} />;
      case 'sepa': return <ModsBatch2Pg s={s} d={d} />;
      case 'compteindividuelannuel': return <PayrollGroupPg s={s} d={d} />;
      // CONCERTATION SOCIALE
      case 'ccts': return <LoisPage s={s} d={d} />;
      case 'delegations': return <LoisPage s={s} d={d} />;
      case 'delegationsyndicale': return <LoisPage s={s} d={d} />;
      case 'egalitehf': return <LoisPage s={s} d={d} />;
      case 'electionsociales': return <LoisPage s={s} d={d} />;
      case 'formationsec': return <LoisPage s={s} d={d} />;
      case 'lanceursalerte': return <LoisPage s={s} d={d} />;
      ...
      case 'audittrail': return <AuditCodePage s={s} d={d} />;
