...
export const MENU = [
  ...
  { id: 'calcmaladie',    label: 'Calcul Maladie',      icon: '🏥', g: 3, keywords: ['maladie','incapacite','salaire garanti','inami','mutualite','arret maladie','conge maladie','30 jours','ouvrier maladie','employe maladie','certificat medical'] },
  ...
  { id: 'simulicenciement', label: 'Simulateur Licenciement', icon: '⚖️', g: 3, keywords: ['licenciement','preavis','indemnite','rupture','statut unique','fin contrat','calcul preavis','cct109','motif grave','depart'] },
  ...
  { id: 'simutp',         label: 'Temps Partiel',       icon: '⏱', g: 3, keywords: ['temps partiel','mi temps','4/5 temps','plancher fictif','onss temps partiel','pro rata','regime partiel','droits partiels'] },
  { id: 'creditemps',     label: 'Crédit-Temps',        icon: '🔄', g: 3, keywords: ['credit temps','cct103','suspension carriere','1/5 temps','mi temps credit','onem credit','allocation credit temps','fin carriere','55 ans'] },
  { id: 'compteIndividuel', label: 'Compte Individuel', icon: '📄', g: 3, keywords: ['compte individuel','recap annuel','bilan travailleur','cotisations annuelles','historique salaire','recapitulatif annuel'] },
  { id: 'chomagetemporaire', label: 'Chômage Temporaire', icon: '⏸', g: 3, keywords: ['chomage temporaire','chomage economique','suspension contrat','c106','onem chomage','allocation chomage','manque travail','intemperie','force majeure'] },
  ...
  { id: 'permissions',    label: 'Rôles & Accès',       icon: '🔐', g: 6, keywords: ['role','acces','permission','utilisateur','admin','droit','securite acces','gestion utilisateur'] },
