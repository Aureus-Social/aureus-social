...
const ETAPES = [
  {
    ...
    obligatoire: true,
    taches: [
      { id: 'niss', moduleAureus: 'onboarding', label: 'Vérifier le NISS du travailleur', detail: 'Numéro de registre national — 11 chiffres. Format: XX.XX.XX-XXX.XX', lien: 'https://www.ksz-bcss.fgov.be', obligatoire: true },
      { id: 'permis', moduleAureus: 'onboarding', label: 'Vérifier permis de travail (si étranger)', detail: 'Ressortissant hors UE : permis de travail obligatoire. UE : libre circulation.', obligatoire: false },
      { id: 'visite', moduleAureus: 'employees', label: 'Planifier visite médicale d\'embauche', detail: 'Obligatoire pour postes à risque (code C ou D). À organiser via le service interne ou externe de prévention (SEPPT).', lien: 'https://www.beswic.be', obligatoire: false },
      { id: 'faux_independant', moduleAureus: 'onboarding', label: '⚠️ Faux indépendant — requalification automatique', detail: "La loi 27/12/2006 fixe 9 critères pour distinguer salarié vs indépendant. Si +3 critères de subordination → requalification en contrat de travail. Conséquences : ONSS arriérés + majorations (10%) + PP + amendes pénales. Contrôlé par inspection sociale et ONSS.", obligatoire: true },
      ...
      { id: 'statut_special', moduleAureus: 'onboarding', label: 'Identifier le statut juridique exact du travailleur', detail: "Étudiant (<600h/an), flexi-job (2e employeur), homeworker (AR 10/10/2012), travailleur domestique (ONSS ménage), dirigeant (mandat vs contrat travail = ONSS différent), artiste (statut ONEM spécial), apprenti CEFA (pas un contrat de travail classique). Chaque statut a un régime ONSS et fiscal distinct.", obligatoire: true },
      ...
      { id: 'vacance_emploi', moduleAureus: 'aidesembauche', label: 'Déclarer la vacance d\'emploi (Actiris/VDAB)', detail: "À Bruxelles : déclaration obligatoire à Actiris avant tout recrutement (ordonnance 14/07/2011). En Flandre : déclaration VDAB obligatoire. En Wallonie : déclaration Forem recommandée. Non-respect : amende administrative.", lien: 'https://www.actiris.brussels', obligatoire: false },
      ...
      { id: 'type_travailleur', moduleAureus: 'onboarding', label: 'Identifier le type de travailleur', detail: "CDI classique, CDD, étudiant (< 600h/an, cotisations réduits 2,71%+5,42%), flexi-job (2e employeur, cotisation 28,07%), intérimaire, indépendant complémentaire. Chaque statut a des règles ONSS différentes.", obligatoire: true },
      { id: 'langue_contrat', moduleAureus: 'contratsmenu', label: '⚠️ Langue du contrat — obligation légale', detail: "À Bruxelles et en Wallonie : contrat en FRANÇAIS obligatoire. En Flandre : contrat en NÉERLANDAIS obligatoire. Un contrat dans la mauvaise langue est NUL et non avenu (décret Vlaamse Gemeenschap + ordonnance bruxelloise).", obligatoire: true },
      { id: 'casier', moduleAureus: 'employees', label: 'Demander extrait de casier judiciaire si nécessaire', detail: 'Requis pour certains secteurs (soins de santé, enfants, sécurité). Pas obligatoire par défaut.', obligatoire: false },
      { id: 'contrat_redige', moduleAureus: 'contratsmenu', label: 'Rédiger le contrat de travail', detail: 'CDI, CDD, temps partiel... Doit mentionner : identité, fonction, rémunération, durée du travail, lieu.', lien: 'https://employment.belgium.be', obligatoire: true },
    ]
  },
  {
    id: 2,
    ...
    taches: [
      ...
      { id: 'dimona_out_prev', moduleAureus: 'declarations', label: 'Encoder la Dimona OUT préventive pour CDD', detail: "Pour un CDD à durée déterminée, encoder la date de fin prévue dès la Dimona IN. Évite les oublis de Dimona OUT et prouve la durée convenue à l'ONSS.", obligatoire: false },
      { id: 'limosa', moduleAureus: 'declarations', label: 'Déclaration LIMOSA si travailleur détaché', detail: "Obligatoire pour tout travailleur étranger détaché temporairement en Belgique. À faire AVANT la prise de service via le portail LIMOSA. Sans cette déclaration : amende jusqu'à 50.000€ par travailleur.", lien: 'https://www.limosa.be', obligatoire: false },
      { id: 'dimona_correctif', moduleAureus: 'declarations', label: 'Possibilité de Dimona correctif (8 jours)', detail: "En cas d'erreur dans la Dimona IN (mauvais NISS, date incorrecte...), un correctif peut être soumis dans les 8 jours ouvrables sans pénalité. Au-delà : amende administrative.", obligatoire: false },
      ...
      { id: 'confirmation', moduleAureus: 'declarations', label: 'Vérifier la confirmation ONSS reçue', detail: 'L\'ONSS renvoie un accusé de réception avec numéro de référence. À conserver.', obligatoire: true },
    ]
  },
  {
    id: 3,
    ...
    obligatoire: true,
    taches: [
      { id: 'contrat_signe', moduleAureus: 'contratsmenu', label: 'Faire signer le contrat de travail', detail: 'Le travailleur doit recevoir un exemplaire signé avant ou le jour de l\'entrée en service.', obligatoire: true },
      { id: 'reglement', moduleAureus: 'contratsmenu', label: 'Remettre le règlement de travail', detail: 'Document légal obligatoire (loi 8/04/1965). Doit mentionner : horaires, rémunération, avantages, procédures disciplinaires.', obligatoire: true },
      { id: 'fiche_salariale', moduleAureus: 'calcinstant', label: 'Informer sur la structure salariale', detail: 'Barème CP applicable, primes éventuelles, chèques-repas, voiture... À documenter.', obligatoire: true },
      { id: 'iban', moduleAureus: 'onboarding', label: 'Collecter l\'IBAN pour virement salaire', detail: 'Compte bancaire belge ou SEPA. Vérifier le format BE + 14 chiffres.', obligatoire: true },
      { id: 'rgpd_consent', moduleAureus: 'onboarding', label: 'Faire signer la déclaration RGPD', detail: 'Informer le travailleur du traitement de ses données personnelles (NISS, coordonnées, salaire). Obligatoire RGPD Art.13.', obligatoire: true },
      ...
      { id: 'deconnexion', moduleAureus: 'contratsmenu', label: 'Droit à la déconnexion — entreprises +20 personnes', detail: "Depuis la loi 26/03/2018 : les entreprises de +20 travailleurs doivent formaliser le droit à la déconnexion dans une CCT d'entreprise ou règlement de travail. Aucune obligation de répondre aux emails/appels hors heures de travail. Absence de règlement = infraction inspectable.", obligatoire: true },
      { id: 'indexation_clause', moduleAureus: 'baremescp', label: 'Indexation automatique des salaires', detail: "En Belgique, les salaires sont indexés automatiquement sur base de l'indice-santé (100% obligatoire). Aucune clause de contrat ne peut y déroger. La date et le taux d'indexation varient par CP (certaines indexent annuellement, d'autres à chaque dépassement du pivot).", obligatoire: true },
      { id: 'bareme_anciennete', moduleAureus: 'baremescp', label: 'Augmentation barémique à l\'ancienneté', detail: "La plupart des CP prévoient des augmentations automatiques liées à l'ancienneté sectorielle (ex: CP 200 : augmentation tous les 2 ans selon catégorie). À calculer dès le 1er anniversaire si applicable.", obligatoire: true },
      ...
      { id: 'fiche_paie_consent', moduleAureus: 'payslip', label: 'Consentement pour fiche de paie électronique', detail: "La fiche de paie papier reste le défaut légal. Passage au numérique : consentement EXPLICITE du travailleur requis (loi 26/03/2018). Sans consentement : fiche papier obligatoire. Le refus ne peut pas être sanctionné.", obligatoire: true },
      { id: 'duree_hebdo', moduleAureus: 'contratsmenu', label: 'Mentionner la durée hebdomadaire exacte', detail: "Obligatoire dans le contrat. Temps plein = 38h/semaine max (ou moins selon CP). Temps partiel : l'horaire EXACT doit figurer dans le contrat, sinon présumé temps plein avec toutes les cotisations.", obligatoire: true },
      { id: 'renouvellement_cdd', moduleAureus: 'contratsmenu', label: 'Règle des 4 renouvellements CDD max', detail: "Maximum 4 renouvellements de CDD avant requalification automatique en CDI, sauf si durée totale dépasse 2 ans ou si CDD unitaire dépasse 3 ans (règle générale). Certaines CP ont des règles différentes.", obligatoire: true },
      { id: 'clause_formation', moduleAureus: 'contratsmenu', label: 'Clause de formation/écolage si applicable', detail: "Si l'employeur finance une formation coûteuse (> 1/5 du salaire annuel), une clause de remboursement proportionnel est possible (max 2 ans, conditions AR 19/07/2013). Doit être signée SÉPARÉMENT, AVANT la formation.", obligatoire: false },
      { id: 'clause_confidentialite', moduleAureus: 'contratsmenu', label: 'Clause de confidentialité', detail: "Distincte de la clause de non-concurrence. Protège les informations commerciales, techniques et stratégiques. Pas de limite de durée légale. Sans compensation financière obligatoire. À inclure systématiquement.", obligatoire: false },
      { id: 'cp_mention', moduleAureus: 'baremescp', label: 'Mentionner la Commission Paritaire dans le contrat', detail: "La CP applicable doit figurer dans le contrat. Elle détermine les barèmes, primes, conditions de travail. Si CP incorrecte dans le contrat, le droit du travailleur le plus favorable s'applique.", obligatoire: true },
      { id: 'motif_cdd', moduleAureus: 'contratsmenu', label: '⚠️ Motif CDD obligatoire dans le contrat', detail: "Un CDD SANS motif valable est requalifié automatiquement en CDI (CCT n°108). Motifs valables : remplacement (nom du travailleur remplacé obligatoire), surcroît temporaire de travail (durée max 6 mois), travaux d'une nature spéciale.", obligatoire: true },
      { id: '276T', moduleAureus: 'onboarding', label: 'Faire remplir le formulaire 276 T (situation familiale)', detail: "Ce formulaire permet d'appliquer le bon taux de précompte professionnel selon la situation familiale (isolé, marié, enfants à charge). Sans ce formulaire, le taux le plus défavorable s'applique automatiquement.", lien: 'https://finances.belgium.be', obligatoire: true },
      { id: 'materiel_teletravail', moduleAureus: 'contratsmenu', label: 'Télétravail — matériel et frais à charge de l\'employeur', detail: "CCT n°149 (2024) : si télétravail structurel, l'employeur doit fournir ou rembourser le matériel nécessaire (PC, connexion internet, chaise ergonomique). Indemnité forfaitaire max 151,70€/mois exonérée ONSS et PP. À formaliser dans l'addendum télétravail.", obligatoire: false },
      { id: 'teletravail_etranger', moduleAureus: 'contratsmenu', label: 'Télétravail depuis l\'étranger — sécurité sociale (Règl. 883/2004)', detail: "Si un travailleur télétravaille depuis un autre pays UE >25% de son temps : risque de double affiliation ONSS. Règlement 883/2004 : pays d'affiliation = pays de résidence si >25% prestations. Accord-cadre multilatéral UE signé 2023 : 49 pays. Vérifier chaque situation individuelle.", lien: 'https://www.socialsecurity.be', obligatoire: false },
      { id: 'teletravail', moduleAureus: 'contratsmenu', label: 'Addendum télétravail si travail à distance', detail: "Si télétravail structurel (régulier) : addendum obligatoire au contrat (CCT n°149, 01/01/2023). Doit mentionner : fréquence, lieu, indemnité forfaitaire (max 151,70€/mois exonéré ONSS et PP).", obligatoire: false },
      { id: 'conges_annuels', moduleAureus: 'gestionabs', label: 'Informer sur les droits aux congés annuels', detail: "En Belgique : 4 semaines (20 jours) pour un temps plein. Ouvriers : via la caisse de vacances (ONVA). Employés : payés par l'employeur. Pécule de vacances = double pécule en mai/juin.", obligatoire: true },
      { id: 'classification', moduleAureus: 'baremescp', label: 'Déterminer la classification de fonction', detail: "La fonction détermine le barème salarial dans la CP. Ex : CP 200 a des barèmes par catégorie (A, B, C...). Impacte le salaire minimum légal applicable.", obligatoire: true },
  ...
  },
  {
    ...
    taches: [
      ...
      { id: 'cp', moduleAureus: 'baremescp', label: 'Identifier la Commission Paritaire applicable', detail: 'Détermine le barème salarial minimum, les primes sectorielles, les congés supplémentaires. Basé sur l\'activité principale de l\'entreprise.', lien: 'https://www.emploi.belgique.be', obligatoire: true },
      { id: 'reduction_bas', moduleAureus: 'aidesembauche', label: 'Vérifier les réductions ONSS applicables', detail: 'Bas salaires (< 3.500€ brut), jeunes non qualifiés, travailleurs âgés (+55 ans). Peuvent réduire jusqu\'à 1.500€/trimestre.', obligatoire: false },
      ...
      { id: 'reduction_premier_emp', moduleAureus: 'aidesembauche', label: 'Réduction premier emploi — conditions strictes', detail: "Pour les jeunes de moins de 26 ans n'ayant jamais travaillé (< 6 mois d'expérience). Réduction ONSS patronale de 1.000€/trimestre pendant max 2 ans. Demande via Dimona avec mention 'FIRST'. À activer AVANT la prise de service.", obligatoire: false },
      { id: 'sesam_bruxelles', moduleAureus: 'aidesembauche', label: 'SESAM Bruxelles — prime CDI premier emploi', detail: "Prime Actiris pour employeurs bruxellois qui engagent en CDI un chercheur d'emploi inscrit chez Actiris depuis + de 6 mois. Jusqu'à 11.250€ sur 3 ans. Demande dans les 3 mois de l'embauche.", lien: 'https://www.actiris.brussels', obligatoire: false },
      { id: 'maladie_pro', moduleAureus: 'accidentTravail', label: 'Maladie professionnelle — déclaration Fedris', detail: "Si le travailleur développe une maladie liée à son activité professionnelle (liste officielle Fedris ou extra-légale) : déclaration obligatoire à Fedris. Indemnisation distincte de l'accident du travail. Médecin conseil désigné.", lien: 'https://www.fedris.be', obligatoire: false },
      { id: 'assurance_groupe', moduleAureus: 'employees', label: 'Assurance groupe/EIP — déclaration FSMA obligatoire', detail: "Si pension complémentaire via assurance groupe ou EIP : déclaration obligatoire à la FSMA (Autorité des services financiers). Contributions patronales : ONSS 8,86% cotisation patronale spéciale. Contributions personnelles : déductibles PP à 30%. Fiche fiscale 281.11 annuelle.", lien: 'https://www.fsma.be', obligatoire: false },
      ...
      { id: 'heures_sup_compteur', moduleAureus: 'payslip', label: 'Compteur d\'heures supplémentaires obligatoire', detail: "Toute heure prestée au-delà de la durée hebdomadaire normale doit être comptabilisée. Récupération (dans les 6 mois) ou sursalaire (50% ou 100% selon jour). Contingent général : 130h/an (temporairement 180h). Registre obligatoire conservé 5 ans.", obligatoire: true },
      { id: 'delai_paiement', moduleAureus: 'sepa', label: 'Délai de paiement du salaire', detail: "Délai légal maximum : 7 jours après la fin de la période de rémunération (ou le lendemain si ce jour est chômé). Paiement exclusivement par virement bancaire (interdiction de paiement en cash au-delà de 3.000€). Retard = intérêts légaux automatiques.", obligatoire: true },
      { id: 'code_risque_at', moduleAureus: 'accidentTravail', label: 'Identifier le code risque Fedris (accidents du travail)', detail: "Chaque poste doit avoir un code risque AT Fedris (NACE). Détermine le taux de prime d'assurance accidents du travail. À communiquer à l'assureur AT lors de l'affiliation du travailleur.", obligatoire: true },
      { id: 'solidarisation', moduleAureus: 'declarations', label: 'Vérification solidarisation ONSS (sous-traitance)', detail: "Si vous faites appel à un sous-traitant avec des dettes ONSS, vous êtes SOLIDAIREMENT responsable (art.40 loi 27/06/1969). Vérifier le statut ONSS du sous-traitant via le portail ONSS avant tout contrat.", lien: 'https://www.socialsecurity.be', obligatoire: false },
      { id: 'indemnite_velo', moduleAureus: 'gestionprimes', label: 'Indemnité vélo : 0,35€/km exonéré', detail: "Si le travailleur vient à vélo : indemnité de 0,35€/km est exonérée d'ONSS et de PP (CCT n°164). Obligation de transport en commun : remboursement 100% dans CP 200 (et beaucoup d'autres CP).", obligatoire: false },
      { id: 'fonds_exist', moduleAureus: 'baremescp', label: 'Vérifier fonds de sécurité d\'existence sectoriel', detail: "Certaines CP ont un FSE obligatoire (CP 124 Construction, CP 140 Transport, CP 302 Horeca...). Cotisation patronale supplémentaire. Finance les primes de fin d'année, les indemnités de licenciement supplémentaires.", obligatoire: false },
      ...
      { id: 'af', moduleAureus: 'declarations', label: 'Déclarer les allocations familiales', detail: "L'employeur doit s'affilier à une caisse d'allocations familiales (Famiwal, Kidslife, etc.) ou à l'ONSS. Le travailleur reçoit les AF directement de la caisse.", lien: 'https://www.famiwal.be', obligatoire: true },
      { id: 'pension_compl', moduleAureus: 'employees', label: 'Vérifier pension complémentaire sectorielle', detail: 'Certaines CP imposent une assurance groupe ou EIP obligatoire. Ex: CP 200, CP 124. Vérifier la CCT sectorielle applicable.', obligatoire: false },
    ]
  },
  {
    id: 5,
    ...
    taches: [
      ...
      { id: 'bonus_emploi', moduleAureus: 'calcinstant', label: 'Appliquer le bonus à l\'emploi si applicable', detail: 'Pour salaires bruts < 2.997,59€/mois. Réduction PP de 33,14%. Maximum 194,03€/mois.', obligatoire: false },
      { id: 'rupture_cdd', moduleAureus: 'simulicenciement', label: 'Indemnité de rupture anticipée CDD (art.40)', detail: "Si l'employeur rompt un CDD avant terme sans motif grave : indemnité = rémunération restante jusqu'au terme, plafonnée à 2x la durée de préavis qui serait applicable en CDI. Attention : pas de préavis possible pour un CDD sauf clause expresse.", obligatoire: true },
      { id: 'preavis_variable', moduleAureus: 'simulicenciement', label: 'Préavis : inclure la rémunération variable', detail: "Depuis CCT n°109 (2014) : la rémunération variable des 12 derniers mois est incluse dans la base de calcul du préavis/indemnité compensatoire. Commissions, primes, avantages en nature... Souvent oublié, source de litiges.", obligatoire: true },
      { id: 'double_pecule', moduleAureus: 'payslip', label: 'Double pécule de vacances — calcul correct', detail: "Le double pécule (pécule de vacances supplémentaire) = 92% du salaire mensuel brut pour un temps plein une année complète. Payé en mai-juin. Ouvriers : via ONVA. Employés : par l'employeur directement.", obligatoire: true },
      { id: 'voiture_co2', moduleAureus: 'gestionprimes', label: 'Voiture de société — politique CO2 et budget mobilité', detail: "Depuis 2026 : seules les voitures 0g CO2 (électriques) restent déductibles à 100%. Voitures thermiques : déductibilité réduite progressivement jusqu'à 0% en 2028. Budget mobilité alternatif possible (CCT sectorielle ou décision employeur) : 0€ ONSS/PP si conditions respectées (AR 24/03/2019).", lien: 'https://finances.belgium.be', obligatoire: false },
      { id: 'prime_fin_annee', moduleAureus: 'gestionprimes', label: 'Prime de fin d\'année / 13e mois', detail: "Si prévue par CCT sectorielle ou contrat : précompte PP spécial à taux réduit 16,5% si ≤ 1 mois de brut. Au-delà : taux ordinaire. À vérifier dans la CCT de votre CP.", obligatoire: false },
      { id: 'atn_avances', moduleAureus: 'gestionprimes', label: 'ATN logement, énergie, PC, prêt — forfaits 2026', detail: "Logement gratuit : ATN = valeur cadastrale × 100/60 × 2 (dirigeant) ou × 2 (salarié). Électricité gratuite : 960€/an (non-cadre) ou 2.130€/an (cadre). Chauffage : 2.130€ (cadre) ou 960€. GSM : 161€/an. PC : 161€/an. Prêt sans intérêt : taux fictif SPF Finances 2026.", obligatoire: false },
      { id: 'stock_options', moduleAureus: 'gestionprimes', label: 'Stock-options — imposition à l\'offre (loi 26/03/1999)', detail: "Les stock-options sont imposées au PP au moment de l'offre (pas de l'exercice). Taux forfaitaire : 18% × valeur × fractions réduction (7,5% ou 15% selon durée). Avantage : pas d'ONSS si conditions respectées. Plan d'options à faire valider fiscalement.", obligatoire: false },
      { id: 'eco_cheques_cond', moduleAureus: 'gestionprimes', label: 'Éco-chèques — conditions d\'octroi strictes', detail: "Max 250€/an exonéré d'ONSS et PP. Nécessite une CCT sectorielle OU une CCT d'entreprise OU un accord individuel écrit. Sans base conventionnelle = soumis à ONSS + PP. Validité 24 mois. Dépense uniquement produits écologiques (liste officielle).", obligatoire: false },
      { id: 'mobilite_durable', moduleAureus: 'gestionprimes', label: 'Allocation mobilité durable — exonération ONSS/PP', detail: "Budget mobilité : alternative à la voiture de société (AR 24/03/2019). Le travailleur peut convertir son budget voiture en transports doux (vélo, abonnement STIB/TEC/De Lijn, voiture partagée...). Entièrement exonéré d'ONSS et de PP dans les limites légales. Conditions strictes : employeur + travailleur doivent y avoir droit.", lien: 'https://www.mobilite.belgique.be', obligatoire: false },
      { id: 'plan_cafeteria', moduleAureus: 'gestionprimes', label: 'Plan cafétéria (flex income plan) — conditions strictes', detail: "Le plan cafétéria permet d'échanger une partie du salaire contre des avantages (vélo, PC, épargne-pension...). Conditions ONSS : seuls les éléments futurs non encore acquis peuvent être échangés. Échange de salaire brut existant = cotisations ONSS dues. Circulaire ONSS 2020/7 applicable.", obligatoire: false },
      { id: 'cla90', moduleAureus: 'gestionprimes', label: 'CLA90 — dépôt préalable obligatoire', detail: "Si bonus non-récurrent CLA90 : dépôt de la CCT ou plan d'avantages NON RÉCURRENTS au SPF ETCS AVANT versement. Sans dépôt : le bonus est traité comme salaire ordinaire (ONSS + PP plein).", lien: 'https://www.emploi.belgique.be', obligatoire: false },
      { id: 'attestation_a', moduleAureus: 'employees', label: 'Remettre attestation A pour la mutualité (délai 15j)', detail: "L'attestation de travail (formulaire 704 / attestation A) doit être remise au travailleur dans les 15 jours. Permet à la mutualité de calculer les droits aux indemnités maladie-invalidité INAMI.", obligatoire: true },
      ...
      { id: 'pp_declaration', moduleAureus: 'declarations', label: 'Déclarer le précompte professionnel (FinProf)', detail: 'Mensuel si > 50.240€/an, trimestriel sinon. Via application FinProf du SPF Finances.', lien: 'https://finances.belgium.be', obligatoire: true },
    ]
  },
  {
    id: 6,
    ...
    taches: [
      ...
      { id: 'cppt', moduleAureus: 'proceduresrh', label: 'CPPT obligatoire si +50 travailleurs', detail: "Le Comité pour la Prévention et la Protection au Travail (CPPT) est obligatoire dès 50 travailleurs. Il doit être consulté AVANT toute décision impactant la sécurité. Sans CPPT : le DS ou la délégation syndicale joue ce rôle.", obligatoire: false },
      { id: 'plan_prevention', moduleAureus: 'proceduresrh', label: 'Plan global de prévention 5 ans', detail: "Obligatoire pour toutes les entreprises (AR 27/03/1998, art.10). Doit identifier tous les risques et les mesures de prévention. Complété par un plan d'action annuel. Doit être soumis au CPPT ou DS.", obligatoire: true },
      { id: 'at_benins', moduleAureus: 'accidentTravail', label: 'Registre des accidents bénins', detail: "Les accidents sans incapacité de travail (blessures légères traitées sur place) doivent être inscrits dans un registre spécial. Conservé à disposition de Fedris et de l'inspection sociale. Obligatoire depuis AR 24/02/2005.", obligatoire: true },
      { id: 'analyse_risques', moduleAureus: 'employees', label: 'Réaliser l\'analyse de risques du poste', detail: "Obligatoire AVANT la prise de service (AR 27/03/1998, art.8). Identifier les risques physiques, chimiques, psychosociaux. Documenter dans le plan global de prévention. Peut déclencher l'obligation de visite médicale d'embauche.", obligatoire: true },
      { id: 'epi', moduleAureus: 'employees', label: 'Fournir les EPI gratuitement', detail: "Les équipements de protection individuelle (casque, gants, chaussures de sécurité, gilet...) sont à la charge EXCLUSIVE de l'employeur. Interdiction de facturer au travailleur. Obligation de formation à leur utilisation.", obligatoire: false },
      { id: 'checkin', moduleAureus: 'declarations', label: 'CheckIn@Work si secteur construction/nettoyage', detail: "Obligatoire pour les chantiers de construction et le nettoyage industriel. Enregistrement électronique via l'application de l'ONSS avant le début des prestations. Amende : 200€ par travailleur non enregistré.", lien: 'https://www.checkinatwork.be', obligatoire: false },
      { id: 'formation', moduleAureus: 'proceduresrh', label: 'Prévoir formation à la sécurité', detail: 'Information sur les risques du poste. Obligatoire pour postes à risque. À documenter dans le registre de formation.', obligatoire: false },
  ...
  },
  {
    ...
    obligatoire: true,
    taches: [
      { id: 'registre', moduleAureus: 'employees', label: 'Inscrire dans le registre du personnel', detail: 'Obligatoire pour tous les travailleurs. Doit contenir : nom, prénom, adresse, date entrée, fonction, CP, type contrat.', obligatoire: true },
      { id: 'dossier', moduleAureus: 'employees', label: 'Créer le dossier individuel du travailleur', detail: 'Contrat signé, Dimona, NISS, IBAN, fiche de poste, déclaration RGPD. À conserver pendant la durée du contrat + 5 ans.', obligatoire: true },
      { id: 'conservation_docs', moduleAureus: 'backup', label: 'Durée légale de conservation des documents', detail: "Contrats de travail : 5 ans après départ. Fiches de paie : 7 ans (prescription fiscale). Dossier médical : 30 ans (médecin travail). Registre personnel : 5 ans après départ. Dimona : 5 ans. Documents ONSS : 7 ans. Non-respect = infraction RGPD + droit social.", obligatoire: true },
      { id: 'bilan_social', moduleAureus: 'rapports', label: 'Bilan social annuel si +100 travailleurs', detail: "Obligatoire pour entreprises +100 travailleurs : dépôt à la BNB (Banque Nationale) dans les 30 jours après l'AG. Contient : effectifs, mouvements, formations, coûts. Public et consultable en ligne.", lien: 'https://www.nbb.be', obligatoire: false },
      { id: 'registre_tps_partiel', moduleAureus: 'employees', label: 'Registre spécial temps partiel + affichage horaire', detail: "Pour chaque travailleur à temps partiel : affichage de l'horaire dans l'entreprise obligatoire (5 jours avant). Registre spécial consultable par l'inspection sociale. Sans ces documents : présomption de temps plein avec toutes les cotisations.", obligatoire: false },
      { id: 'depot_greffe', moduleAureus: 'contratsmenu', label: 'Déposer le règlement de travail au greffe', detail: "Le règlement de travail MODIFIÉ doit être déposé au greffe du tribunal du travail dans les 8 jours (loi 8/04/1965, art.21). Pour un premier règlement, délai de 3 mois. Pas obligatoire si aucune modification.", obligatoire: false },
  ...
  },
  {
    ...
    obligatoire: false,
    taches: [
      { id: 'conges_circonstances', moduleAureus: 'gestionabs', label: 'Congés de circonstances (jours légaux)', detail: "Mariage travailleur : 2j · Mariage enfant : 1j · Naissance/adoption : 10j (coparentalité) · Décès conjoint/enfant : 3j · Décès parent/beau-parent : 3j · Communion solennelle enfant : 1j · Déménagement : 1j (si CCT). Ces jours sont à la charge de l'employeur.", obligatoire: true },
      { id: 'maternite', moduleAureus: 'gestionabs', label: 'Congé de maternité — notification INAMI 7 semaines avant', detail: "15 semaines minimum (19 si grossesse multiple). La travailleure doit notifier l'INAMI et l'employeur au moins 7 semaines avant le terme. Congé prénatal obligatoire (1 semaine avant terme). Indemnisé par INAMI à 82% puis 75%.", lien: 'https://www.inami.fgov.be', obligatoire: true },
      { id: 'paternite', moduleAureus: 'gestionabs', label: 'Congé de paternité/coparentalité — 20 jours', detail: "20 jours dans les 4 mois suivant la naissance (loi 3/07/1978). Les 3 premiers jours à charge de l'employeur. Du 4e au 20e : indemnité INAMI (82% du salaire plafonné). Formulaire INAMI à remplir.", lien: 'https://www.inami.fgov.be', obligatoire: true },
      ...
      { id: 'formation_deal', moduleAureus: 'proceduresrh', label: 'Droit à la formation — 5j/an (Deal emploi 2022)', detail: "Depuis 01/01/2023 : chaque travailleur a droit à 5 jours de formation par an (entreprises +20 personnes). L'employeur doit établir un plan de formation individuel. Non-respect : astreinte de 1.800€ par travailleur.", lien: 'https://employment.belgium.be', obligatoire: true },
      { id: 'credit_temps_info', moduleAureus: 'creditemps', label: 'Informer sur le crédit-temps (CCT n°103)', detail: "Tout travailleur peut demander un crédit-temps après 12 mois d'ancienneté. Réduction 1/5 (CDI), mi-temps ou interruption complète. Allocation ONEM si motif reconnu (soin enfant, formation, soins palliatifs). L'employeur ne peut pas refuser unilatéralement.", lien: 'https://www.onem.be', obligatoire: false },
      { id: 'outplacement', moduleAureus: 'simulicenciement', label: 'Outplacement obligatoire si licenciement futur (+45 ans)', detail: "Si le travailleur a +45 ans et est licencié avec préavis > 30 semaines : outplacement obligatoire (CCT n°82). Coût à charge de l'employeur. À mentionner dès le contrat pour les profils concernés.", obligatoire: false },
      { id: 'protection_maternite', moduleAureus: 'proceduresrh', label: 'Protection contre le licenciement — maternité/crédit-temps', detail: "Interdiction de licencier une travailleuse enceinte (de la grossesse à 1 mois après reprise). Protection aussi pendant crédit-temps (6 mois), congé parental (6 mois). Violation = indemnité forfaitaire 6 mois + dommages.", obligatoire: true },
    ]
  },
  {
  ...
  },
  {
    ...
    taches: [
      ...
      { id: 'motif_grave_3j', moduleAureus: 'simulicenciement', label: 'Licenciement motif grave — délai 3 jours ouvrables', detail: "Notification dans les 3 jours ouvrables suivant la connaissance des faits. Lettre recommandée obligatoire. Si délai raté : requalification en licenciement ordinaire avec indemnité. Motif doit être précis et documenté.", obligatoire: true },
      ...
      { id: 'cct109_raison', moduleAureus: 'simulicenciement', label: 'CCT n°109 — licenciement manifestement déraisonnable', detail: "Tout licenciement sans motif valable peut être contesté. Indemnité : 3 à 17 semaines de salaire. Employeur peut devoir communiquer le motif si demandé dans les 2 mois. Documentation du dossier disciplinaire essentielle.", obligatoire: true },
      { id: 'c4_codes_onem', moduleAureus: 'offboarding', label: 'Formulaire C4 — codes ONEM obligatoires', detail: "Doit mentionner : durée et nature du contrat, motif de fin avec codes ONEM précis, heures travaillées, rémunération. À remettre IMMÉDIATEMENT. Erreur sur le motif = amende ONEM et chômage refusé.", obligatoire: true },
      { id: 'solde_compte', moduleAureus: 'offboarding', label: 'Solde de tout compte — éléments obligatoires', detail: "Inclure : salaire dernier mois, pécule de vacances restant, indemnité compensatoire de préavis, prime de fin d'année proratisée, remboursement frais en attente. Maximum 5 jours ouvrables après fin.", obligatoire: true },
    ]
  },
  {
