...
,
  {
    id: 19, icon: '🏠', titre: 'Télétravail & Travail flexible', delai: 'Si applicable', color: '#06b6d4', obligatoire: false,
    taches: [
      { id: 'cct149_2024', label: 'CCT n°149 (2024) — nouveau cadre télétravail structurel', detail: "CCT n°149 en vigueur depuis 2024. Télétravail structurel = régulier et prévisible. Addendum obligatoire : fréquence, lieu, matériel, indemnité. Droit de refus travailleur protégé. Droit de retour en présentiel garanti.", lien: "https://cnt-nar.be', obligatoire: true },
      { id: 'semaine_4j', label: 'Semaine de 4 jours — droit légal depuis 2022', detail: "Depuis le Deal emploi 2022 : tout salarié peut demander la semaine de 4 jours (38h en 4 jours). L'employeur ne peut refuser que pour raisons objectives écrites dans le mois. Essai de 6 mois renouvelable.", obligatoire: true },
      { id: 'horaire_variable', label: 'Horaire variable — plages fixes et mobiles', detail: "Horaire glissant : plage fixe (présence obligatoire ex: 10h-15h) + plage mobile (travailleur choisit). Compteur d"écarts : solde max +12h/-12h. A la fin du cycle : solde doit revenir à zéro ou report limité. CCT ou avenant requis.", obligatoire: false },
      { id: 'heures_sup_vol', label: 'Heures supplémentaires volontaires — 360h/an max', detail: "Accord individuel écrit : jusqu'à 360h/an de dépassement volontaire. Payées avec sursalaire (50% ou 100% selon jour). Pas de repos compensatoire obligatoire. Exonération PP sur 130 premières heures.", obligatoire: false },
      { id: 'prestation_3h_min', label: 'Prestation minimale 3h — obligation légale', detail: "Toute prestation imposée par l'employeur doit être d'au moins 3 heures consécutives (loi travail faisable 2017). Exception : si le travailleur demande lui-même moins de 3h. Violation = infraction niveau 2.", obligatoire: true },
      { id: 'nuit_notification', label: 'Travail de nuit — notification inspection sociale préalable', detail: "Avant d'introduire le travail de nuit : avis préalable du CPPT ou DS, puis notification à l'inspection sociale. Travail de nuit = entre 20h00 et 6h00. Sursalaire ou avantage équivalent obligatoire (selon CP).", obligatoire: false },
    ]
  },
  {
    id: 20, icon: '🏥', titre: 'Maladie, Accidents & Retour', delai: 'A connaître dès J1', color: '#f43f5e', obligatoire: false,
    taches: [
      { id: 'cert_medical_2j', label: 'Certificat médical dans les 2 jours ouvrables', detail: "Obligation légale : certificat médical remis dans les 2 jours ouvrables. Employeur peut prévoir 1 jour de carence sans certificat par CCT. Faux certificat = faute grave justifiant licenciement immédiat sans préavis.", obligatoire: true },
      { id: "medecin_controle', label: 'Médecin-contrôle — droits et obligations', detail: "Employeur peut mandater un médecin-contrôle. Travailleur obligé d"ouvrir entre 9h-11h ET 14h-16h. Peut appeler son médecin traitant pendant le contrôle. Peut contester en demandant un médecin-arbitre. Refus injustifié = suspension salaire garanti.", obligatoire: false },
      { id: 'salaire_garanti_30j', label: 'Salaire garanti maladie — calcul exact 30 jours', detail: "Jours 1-7 ouvrables : 100% brut. Jours 8-14 : 100% ouvrables + 85,88% non-ouvrables. Jours 15-30 : 25,68% du salaire mensuel brut. Pour OUVRIERS avec < 2 ans d"ancienneté : délai de carence de 2,5 jours.", obligatoire: true },
      { id: 'at_8jours', label: "Accident du travail — déclaration dans 8 jours à l'assureur", detail: "Tout AT (même bénin) déclaré à l'assureur AT dans les 8 jours calendrier. Accident grave/mortel : immédiatement. Conservation des lieux en l'état. Non-déclaration = refus possible d'indemnisation + amende.", lien: 'https://www.fedris.be', obligatoire: true },
      { id: 'trajet_reintegration', label: 'Trajet de réintégration — après 9 mois incapacité', detail: "Loi 26/12/2016 : après 9 mois d'incapacité, l'INAMI peut déclencher un trajet de réintégration. L'employeur doit examiner les possibilités dans les 90 jours. Travail adapté, autre poste ou formation reconversion. Refus injustifié = amende.", obligatoire: true },
      { id: 'visite_pre_reprise', label: 'Visite médicale avant reprise — postes sécurité', detail: "Postes à risque (code A sécurité) : visite de reprise AVANT la 1ère journée après toute absence. Autres postes : visite obligatoire après 4 semaines. Ne jamais faire travailler un travailleur sans avis d'aptitude médicale.", obligatoire: true },
    ]
  },
  {
    id: 21, icon: '📋', titre: 'Licenciement & Fin de contrat', delai: 'A préparer', color: '#dc2626', obligatoire: false,
    taches: [
      { id: 'preavis_tableau', label: 'Préavis — tableau complet CCT n°109 (statut unique)', detail: "0-3 mois=1 semaine | 3-6 mois=2 sem | 6-9 mois=3 sem | 9-12 mois=4 sem | 1-2 ans=6 sem | 2-3 ans=7 sem | ... 10-11 ans=14 sem | +1 semaine par année d'ancienneté supplémentaire. Rémunération variable 12 derniers mois INCLUSE dans la base de calcul.", obligatoire: true },
      { id: 'motif_cct109', label: 'Motif licenciement — droit du travailleur CCT n°109', detail: "Dans les 2 mois de la fin du contrat : le travailleur peut demander le motif par écrit. L'employeur a 2 mois pour répondre avec le motif concret. Motif manifestement déraisonnable = indemnité 3-17 semaines. Charge de la preuve sur l'employeur.", obligatoire: true },
      { id: 'faute_grave_3j', label: 'Faute grave — notifier dans les 3 jours ouvrables', detail: "Licenciement pour faute grave (sans préavis ni indemnité) : notifier par lettre recommandée dans les 3 jours ouvrables après avoir eu connaissance des faits. La lettre doit décrire précisément la faute. Après 3 jours : la faute ne peut plus être invoquée.", obligatoire: true },
      { id: "c4_immediatement', label: 'C4 — remis le jour même de la fin du contrat', detail: "Le formulaire C4 doit être remis ou envoyé (ASR électronique à l"ONEM) le jour même de la fin du contrat. Retard = amende ONEM + dommages et intérêts au travailleur. Sans C4 valide : le travailleur ne peut pas s'inscrire au chômage.", obligatoire: true },
      { id: 'attestation_vacances_fin', label: 'Attestation de vacances — remise à la fin du contrat', detail: "L"employeur doit remettre une attestation de vacances mentionnant les droits acquis et le pécule payé. Permet au nouvel employeur de calculer correctement les vacances de l'année en cours. Obligatoire pour tous les employés.", obligatoire: true },
      { id: 'solde_5j', label: 'Décompte final — dans les 5 jours ouvrables', detail: "Toutes les sommes dues (salaire, heures sup, prorata 13e mois, indemnité de préavis...) doivent être payées dans les 5 jours ouvrables suivant la fin du contrat. Retard = intérêts légaux automatiques (taux légal).", obligatoire: true },
      { id: "offboarding_liste', label: 'Checklist offboarding complète', detail: "Récupérer : badge, clés, PC, téléphone, voiture, carte essence, EPI, vêtements. Supprimer : tous accès IT, email, applications le jour même (RGPD). Remettre : C4, attestation vacances, décompte final, certificat d'emploi si demandé.", obligatoire: true },
    ]
  },
  {
    id: 22, icon: '🌱', titre: 'Egalité, Diversité & Inclusion', delai: 'Obligations légales', color: '#16a34a', obligatoire: false,
    taches: [
      { id: 'criteres_19', label: '19 critères de discrimination interdits', detail: "Loi 10/05/2007 : âge, orientation sexuelle, état civil, naissance, fortune, conviction religieuse/philosophique/politique, langue, état de santé actuel/futur, handicap, caractéristique physique ou génétique, origine sociale, nationalité, race, couleur, ascendance, origine nationale/ethnique. Charge de preuve PARTAGÉE.", lien: "https://www.unia.be', obligatoire: true },
      { id: 'remuneration_egale', label: 'Egalité de rémunération H/F — CCT n°25 obligatoire', detail: "Salaire identique pour travail identique ou de valeur égale entre H et F. Différence injustifiée = discrimination. Le travailleur peut demander l'égalisation vers le haut. L'employeur prouve que la différence est objective et non discriminatoire.", obligatoire: true },
      { id: 'harcelement_etapes', label: 'Procédure harcèlement — 5 étapes légales', detail: "1) Personne de confiance/conseiller. 2) Procédure informelle (conciliation). 3) Plainte formelle écrite. 4) Enquête dans 3 mois. 5) Mesures de protection immédiates. L"employeur qui n'agit pas est civilement responsable des dommages.", obligatoire: true },
      { id: 'violence_tiers', label: 'Violence de tiers — protection obligatoire employeur', detail: "AR 10/04/2014 : l'employeur doit protéger les travailleurs contre la violence provenant de clients, fournisseurs, public. Analyse de risques + mesures préventives + procédure de déclaration. Secteurs exposés : soins, commerce, transport, enseignement.", obligatoire: true },
      { id: 'grossesse_adaptation', label: 'Adaptation du poste — travailleuse enceinte', detail: "Dès déclaration de grossesse : évaluation des risques obligatoire (AR 2/05/1995). Produits chimiques, postures prolongées, stress, horaires nuit... Si risque identifié : adaptation du poste ou poste alternatif ou, si impossible, dispense avec maintien de salaire à 100%.", obligatoire: true },
      { id: 'allaitement_30min', label: 'Pauses allaitement — 30 min × 2/j pendant 7 mois', detail: "Loi 16/03/1971 art.39bis : pauses allaitement rémunérées (30 min × 2/jour) pendant 7 mois après la naissance. Local adapté obligatoire (AR 15/02/2007). Refus de l"employeur = discrimination sur base de la maternité.", obligatoire: true },
    ]
  },
  {
    id: 23, icon: '📊', titre: 'Reporting & Calendrier annuel', delai: 'Dates fixes', color: '#7c3aed', obligatoire: true,
    taches: [
      { id: 'belcotax_avant1mars', label: 'Belcotax 281.xx — avant le 1er mars chaque année', detail: "Fiches fiscales annuelles : 281.10 (salariés), 281.11 (assurance groupe), 281.20 (commissions)... Via Belcotax-on-web SPF Finances. Avant le 1er mars. Retard : amende 50€ par fiche. Correction possible jusqu'au 31 mai.", lien: 'https://finances.belgium.be', obligatoire: true },
      { id: 'dmfa_4par_an', label: 'DmfA — 4 déclarations trimestrielles ONSS', detail: "T1 (jan-mars) → 30 avril | T2 (avr-juin) → 31 juillet | T3 (juil-sep) → 31 octobre | T4 (oct-déc) → 31 janvier. Une ligne par travailleur. Retard : majoration 10% + intérêts. DmfA correctif possible dans les 5 ans.", obligatoire: true },
      { id: 'finprof_13_15', label: 'Précompte professionnel — entre le 13 et 15 du mois', detail: "Mensuel si PP annuel > 50.240€, trimestriel sinon. Paiement sur compte SPF Finances entre le 13 et 15 du mois. Non-paiement : intérêts 7%/an + amende administrative. Référence structurée obligatoire sur le virement.", obligatoire: true },
      { id: "plan_form_31mars', label: 'Plan de formation — avant le 31 mars chaque année', detail: "Entreprises +20 travailleurs : plan de formation annuel soumis au CE ou DS avant le 31 mars. Minimum 5 jours/travailleur/an. Rapport d'exécution fin d'année. Défaut = amende + risque d'astreinte judiciaire.", obligatoire: true },
      { id: 'bilan_social_bnb', label: 'Bilan social BNB — dans les 30 jours après AG', detail: "+100 travailleurs : bilan social obligatoire déposé à la BNB dans les 30 jours après l'AG. Effectifs, mouvements, formations, coûts. Public sur bilan-annuel.bnb.be.", lien: 'https://www.nbb.be', obligatoire: false },
      { id: 'rapport_egal_2ans', label: 'Rapport égalité salariale H/F — tous les 2 ans', detail: "Loi 22/04/2012 : rapport bisannuel sur l"égalité des rémunérations H/F. +50 travailleurs. Délai : 31 décembre des années paires. Soumis au CE ou DS. Plan d'action obligatoire si écart injustifié.", obligatoire: false },
    ]
  },
  {
    id: 24, icon: '🌐', titre: 'Mobilité internationale avancée', delai: 'Cas complexes', color: '#0891b2', obligatoire: false,
    taches: [
      { id: 'a1_avant_depart', label: 'Formulaire A1 — AVANT tout détachement UE', detail: "Obligatoire avant toute mission dans un pays UE. Prouve l'affiliation ONSS belge. Délivré par l'ONSS (délai 5-15 jours ouvrables). Sans A1 : double cotisation possible + amende dans le pays d'accueil.", lien: 'https://www.socialsecurity.be', obligatoire: false },
      { id: 'accord_cadre_49pays', label: 'Accord-cadre 49 pays — télétravail transfrontalier', detail: "49 pays signataires dont tous les pays UE : télétravail jusqu'à 49,9% depuis le pays de résidence sans changer d'affiliation ONSS. Au-delà 50% : pays de résidence devient compétent. Demande de décision anticipée à l'ONSS.", obligatoire: false },
      { id: 'cdi_double_imposition', label: 'Convention préventive double imposition (CDI)', detail: "La Belgique a signé des CDI avec +100 pays. Détermine quel pays impose le salaire. Règle générale : pays où le travail est physiquement presté. Exception : détachements < 183 jours/an dans certaines conventions. Ruling préalable recommandé.", lien: 'https://finances.belgium.be', obligatoire: false },
      { id: 'expat_regime_2022', label: 'Régime spécial expatriés — 30% exonéré PP', detail: "Circulaire 2022 : 30% du salaire contractuel exonéré de PP + remboursement frais répétitifs exonéré. Conditions : premier emploi en Belgique (ou absent 5+ ans), rémunération brute ≥ 75.000€/an, compétences spécifiques prouvées. Demande dans les 3 mois de l'embauche.", obligatoire: false },
      { id: 'mtcm_anticiper', label: 'MTCM hors UE — anticiper 90 jours minimum', detail: "Travailleur hors UE : titre de séjour unique (MTCM) à demander au moins 90 jours à l"avance. Sans MTCM valide : amende jusqu'à 6.000€ par travailleur + responsabilité solidaire ONSS. Vérification périodique de la validité obligatoire.", obligatoire: false },
      { id: 'totalisation_ue', label: 'Totalisation des périodes UE — droits sociaux', detail: "Travailleur ayant travaillé dans plusieurs pays UE : peut cumuler ses périodes pour accéder aux prestations sociales (chômage, pension, invalidité...). Chaque pays calcule sa part proportionnelle. Formulaire P1 pour pension internationale.", obligatoire: false },
    ]
  },
export default function EmbaucheAZ() {
  ...
  const TOUTES_ETAPES = typeof ETAPES_EXTRA !== 'undefined' ? [...ETAPES, ...ETAPES_EXTRA] : ETAPES;
  const totalTaches = TOUTES_ETAPES.flatMap(e => e.taches).length
