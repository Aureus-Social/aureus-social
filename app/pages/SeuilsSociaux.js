...
export function DashDelegation({s,d}){return <div style={{padding:40,textAlign:'center',color:'#5e5c56'}}>Module DashDelegation</div>;}
export function EgaliteHF({s,d}){return <div style={{padding:40,textAlign:'center',color:'#5e5c56'}}>Module EgaliteHF</div>;}
export function GestionElections({s,d}){return <div style={{padding:40,textAlign:'center',color:'#5e5c56'}}>Module GestionElections</div>;}
