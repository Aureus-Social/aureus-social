...
function FloatingLegalAgent({onAction}){
  ...
  ,
    {q:['plan café','cafétéria','cafetariaplan','avantages sur mesure','wage conversion'],a:{fr:'**Plan cafétéria 2026**\n\nBudget employeur réparti librement par le travailleur entre avantages exonérés ONSS+fiscal:\n• Vélo: 0,35€/km (non-plafonné)\n• PC privé: ≤40€/mois\n• Abonnement transport STIB/SNCB/De Lijn\n• Épargne-pension extra-légale\n• Chèques sport/culture: max 100€/an\n\n**Wage conversion**: sacrifice salarial = économie ONSS sur le montant converti.\n**Condition**: respecter le barème CP minimum.\n\n📋 Circulaire SPF Finances 2022/C/68'}},
    {q:['outplacement','reclassement','loopbaanbegeleiding','bilan carrière'],a:{fr:'**Outplacement — CCT 51**\n\n**Droit**: travailleur licencié avec préavis ≥30 semaines (ou equiv) + 1 an d\'ancienneté.\n**45 ans+**: TOUJOURS droit à outplacement (peu importe durée préavis).\n\n**Contenu**: 60h sur 12 mois (bilan, CV/LinkedIn, coaching emploi).\n**Coût**: à charge employeur (~1.800-3.600€).\n**Délai offre**: 15j après fin contrat/accès indemnité.\n\n**Sanction** si absent: cotisation ONSS spéciale = 1/3 salaire annuel (max ≈37.000€).\n\n📋 CCT 51 (CNT), Loi 5/9/2001'}},
    {q:['réduction groupe cible','doelgroepvermindering','groupe cible','premier engagement','activa'],a:{fr:'**Réductions groupe-cible 2026**\n\n**1ers engagements (PME)**:\n• 1er travailleur: exonération totale ONSS patronal (permanente)\n• 2e: -1.550€/trim × 5 ans\n• 3e: -1.050€/trim × 2 ans\n• 4e-5e: -1.050€/trim × 1 an\n\n**Activa.brussels** (Bruxelles):\n• 350€/mois (6m) → 500€/mois (12m) → 350€/mois (12m) = max 13.800€/30 mois\n• Condition: chômeur inscrit Actiris ≥6 mois\n\n**Jeunes -26 ans**: -1.150€/trim × 8 trim\n\n📋 AR 11/12/2013, Ordonnances régionales'}},
    {q:['temps partiel','mi-temps','deeltijds','4/5 temps','travail partiel'],a:{fr:'**Travail à temps partiel**\n\n**Types**: fixe (ex: 4/5=32h/sem) ou variable (annonce 5j avant).\n\n**Obligations employeur**:\n• Contrat ÉCRIT avant début (obligatoire)\n• Régime + horaire dans contrat ou règlement travail\n• Avenant pour toute modification\n\n**ONSS**: si salaire partiel < plancher sectoriel → ONSS calculé sur le plancher fictif.\n\n**Droits**: proportionnels (pécule, chèques-repas pro-rata). Priorité pour postes temps plein.\n\n📋 Loi 3/7/1978, art. 11bis; AR 9/11/1987'}},
    {q:['travail de nuit','nachtarbeid','prime nuit','22h','poste nuit'],a:{fr:'**Travail de nuit**\n\n**Définition**: prestations entre 20h et 6h (ou 22h selon CCT sectorielle).\n\n**Autorisation**: prévoir dans règlement travail OU CCT.\n\n**Majorations courantes**:\n• CP 200/général: +25-35%\n• Construction (CP 124): +35%\n• Alimentaire (CP 118): +25%\n• Horeca (CP 302): +35-50%\n\n**Protections**:\n• Visite médicale avant affectation\n• Travailleuse enceinte: droit au passage au jour\n• Limite: 8h/nuit (sauf dérogation)\n• Repos: 11h entre 2 prestations\n\n📋 Loi 16/3/1971, art. 35-40; CCTs sectorielles'}},
    {q:['rupture amiable','accord rupture','consentement mutuel','minnelijke beeindiging'],a:{fr:'**Rupture amiable**\n\n**Accord écrit** signé par les deux parties (libre et éclairé).\n\n**Risque chômage**: rupture amiable ≠ licenciement. ONEM peut refuser les allocations si jugée "volontaire".\n\n**Solution**: clause de responsabilité employeur + indemnité compensatoire.\n\n**Indemnité transactionnelle**:\n• Partie ≤ indemnité légale: exonérée ONSS\n• Au-delà: imposable fiscalement\n\n**Ne jamais signer sous pression** — travailleur peut contester devant tribunal du travail.\n\n📋 Art. 1134 C.civ.; jurisprudence C.trav. Bruxelles'}},
    {q:['CCT 104','seniors','sénior','55 ans','emploi travailleur âgé','plan emploi'],a:{fr:'**CCT 104 — Plan emploi travailleurs âgés**\n\n**Obligation**: entreprises ≥20 FTE, plan bisannuel pour maintenir/augmenter emploi des 45+.\n\n**Contenu**: analyse situation 45+, mesures concrètes (formation, aménagement poste, tutorat, télétravail), objectifs chiffrés.\n\n**Procédure**: concertation CE/CPPT/délégation syndicale + dépôt SPF ETCS.\n\n**Sanction**: 750-2.500€ d\'amende pour absence de plan.\n\n📋 CCT 104 (CNT), AR 14/7/1987'}}];
