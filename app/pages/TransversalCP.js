...
// ════════════════════════════════════════════════════════════
// 9b. DONNÉES COMPLÉMENTAIRES — CP SUPPLÉMENTAIRES
// ════════════════════════════════════════════════════════════

// Majorations CP supplémentaires
Object.assign(MAJORATIONS, {
  '100':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos compensatoire obligatoire'},ferie:{taux:100,repos:true},samedi:{taux:20,note:'Après 13h'}},
  '101':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos compensatoire'},ferie:{taux:100,repos:true}},
  '102':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Double salaire + repos'},ferie:{taux:100,repos:true},equipe2x8:{taux:8},equipe3x8:{taux:15}},
  '104':{nuit:{taux:15,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '105':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '109':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos obligatoire'},ferie:{taux:100,repos:true},equipe3x8:{taux:15}},
  '110':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '112':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '113':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '114':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '115':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true},hauteur:{taux:10},insalubrite:{taux:5}},
  '116':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '117':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true},insalubrite:{taux:10,note:'Industries chimiques'}},
  '120':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true},equipe2x8:{taux:8},equipe3x8:{taux:15}},
  '122':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '125':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '126':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '127':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '128':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true},equipe2x8:{taux:8}},
  '129':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '130':{nuit:{taux:25,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true},equipe3x8:{taux:20},insalubrite:{taux:10,note:'Industrie du verre'}},
  '132':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '133':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '136':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '142':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '143':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '144':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '145':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '146':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '148':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true},equipe2x8:{taux:8}},
  '150':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '201':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '202':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '207':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '209':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '210':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '218':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '220':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '222':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '226':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '227':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '301':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '303':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '304':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '306':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '307':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '308':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '309':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '310':{nuit:{taux:0,note:'Pas de travail de nuit habituel'},dimanche:{taux:100,note:'Rare'},ferie:{taux:100,repos:true}},
  '311':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '312':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '313':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '314':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '315':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '317':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '318':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '319':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '320':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '321':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '322':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '323':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '324':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '325':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '326':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '327':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '328':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '329':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '331':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '332':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '333':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '334':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '336':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '337':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '338':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '340':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '341':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
  '342':{nuit:{taux:20,heures:'22h-6h'},dimanche:{taux:100,note:'Repos comp.'},ferie:{taux:100,repos:true}},
});

// Congés sectoriels complémentaires
Object.assign(CONGES_SECTORIELS, {
  '100':{legal:20,sectoriels:[{nom:'Jours de récupération',jours:6},{nom:'Congé sectoriel Fonds métal',jours:12,note:'Convention annuelle'}],note:'Ouvriers secteur métal — vérifier CCT annuelle'},
  '102':{legal:20,sectoriels:[{nom:'Congés de récupération équipes',jours:8},{nom:'Jours sectoriels',jours:4}],note:'Fabrications métalliques — travail en équipe'},
  '104':{legal:20,sectoriels:[{nom:'Jours supplémentaires CP104',jours:6}],note:'Industrie du gaz'},
  '109':{legal:20,sectoriels:[{nom:'Congés sectoriels garages',jours:4}],note:'Vérifier convention sectorielle annuelle'},
  '110':{legal:20,sectoriels:[{nom:'Congés récupération',jours:6}],note:'Boulangerie industrielle'},
  '112':{legal:20,sectoriels:[{nom:'Congés fibrociment',jours:4}],note:'Industry du ciment'},
  '113':{legal:20,sectoriels:[{nom:'Congés récupération industrie',jours:4}],note:'Verre et céramique'},
  '114':{legal:20,sectoriels:[{nom:'Congés récupération',jours:6}],note:'Produits chimiques'},
  '115':{legal:20,sectoriels:[{nom:'Congés récupération',jours:6}],note:'Industries extractives'},
  '116':{legal:20,sectoriels:[{nom:'Congés récupération',jours:4}],note:'Industrie du papier'},
  '120':{legal:20,sectoriels:[{nom:'Congés récupération',jours:6}],note:'Industrie alimentaire'},
  '121':{legal:20,sectoriels:[{nom:'Jours extra nettoyage',jours:4}],note:'Entreprises de nettoyage'},
  '122':{legal:20,sectoriels:[{nom:'Congés vêtements',jours:4}],note:'Industrie textile et confection'},
  '124':{legal:20,sectoriels:[{nom:'Congé payé supplémentaire',jours:8},{nom:'Pont de la Toussaint',jours:1},{nom:'Pont du 11/11 ou 25/12',jours:1}],note:'Construction — 30 jours légaux + 6 sectoriels effectifs'},
  '130':{legal:20,sectoriels:[{nom:'Congés récupération verre',jours:6},{nom:'Arrêt collectif',jours:'Variable',note:'Fermeture annuelle usine'}],note:'Industrie du verre'},
  '132':{legal:20,sectoriels:[{nom:'Congés récupération',jours:4}],note:'Industrie du bois'},
  '133':{legal:20,sectoriels:[{nom:'Congés récupération',jours:4}],note:'Ameublement'},
  '136':{legal:20,sectoriels:[{nom:'Congés récupération',jours:4}],note:'Industrie des tabacs'},
  '140':{legal:20,sectoriels:[{nom:'Repos compensatoires chauffeurs',jours:'Variable'},{nom:'Congés poids lourds',jours:2}],note:'Transport routier — temps de conduite réglementé'},
  '201':{legal:20,sectoriels:[{nom:'Congés secteur assurances',jours:2}],note:'Assurances'},
  '202':{legal:20,sectoriels:[{nom:'Congés professions libérales',jours:2}],note:'Professions libérales'},
  '207':{legal:20,sectoriels:[{nom:'Congés commerce alimentation',jours:2}],note:'Commerce alimentaire'},
  '209':{legal:20,sectoriels:[{nom:'Congés employés de maison',jours:2}],note:'Services domestiques'},
  '218':{legal:20,sectoriels:[{nom:'Congés sociaux CPAS',jours:4}],note:'CPAS et services sociaux'},
  '302':{legal:20,sectoriels:[{nom:'3 jours sectoriels horeca',jours:3},{nom:'Fermeture annuelle',jours:'Variable',note:'Selon CCT entreprise'}],note:'Horeca — 23 jours effectifs en pratique'},
  '310':{legal:20,sectoriels:[{nom:'Congés bancaires',jours:2}],note:'Banques et assurances'},
  '330':{legal:20,sectoriels:[{nom:'Congés secteur santé',jours:4},{nom:'Repos compensatoires garde',jours:'Variable'}],note:'Soins de santé — RCC importantes'},
  '336':{legal:20,sectoriels:[{nom:'Congés professions libérales',jours:2}],note:'Professions libérales, CP 336'},
});

// Indexation complémentaire
Object.assign(INDEXATION_CP, {
  '100':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Métal secteur ouvriers'},
  '101':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Métal — CP101'},
  '102':{mecanisme:'Index santé sectoriel',date:'Janvier/Juillet',coefficient:'Automatique',frequence:'Semestrielle',dernier:'01/01/2026',pctDernier:2.0,note:'Fabrications métalliques'},
  '104':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Gaz, électricité'},
  '109':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Garages — CP109'},
  '110':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Boulangerie industrielle'},
  '120':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Industrie alimentaire'},
  '122':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Textile et confection'},
  '130':{mecanisme:'Index santé sectoriel',date:'Juillet',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/07/2025',pctDernier:2.0,note:'Verre — révision juillet'},
  '132':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Bois'},
  '133':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Ameublement'},
  '140':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Transport routier'},
  '201':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'CP 200 employés assurances'},
  '202':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Professions libérales'},
  '207':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Commerce alimentaire'},
  '310':{mecanisme:'Accord sectoriel banques',date:'Selon protocole',coefficient:'Négocié',frequence:'Variable',dernier:'01/01/2026',pctDernier:2.0,note:'Banques — accord bipartite'},
  '336':{mecanisme:'Index santé',date:'Janvier',coefficient:'Automatique',frequence:'Annuelle',dernier:'01/01/2026',pctDernier:2.0,note:'Professions libérales CP336'},
});
            ...
            {catPrimes.map((p,i)=>{const k=cat+'-'+i;const isExp=expanded[k];const d=p.details;return <div key={i} style={{borderBottom:'1px solid rgba(255,255,255,.03)'}}>
              ...
              {isExp&&d&&<div style={{padding:'0 0 14px 0',animation:'fadeIn .2s'}}>
                <div style={{background:'rgba(198,163,78,.04)',borderRadius:10,padding:14,border:'1px solid rgba(198,163,78,.1)'}}>
                  {d.base_legale&&<div style={{marginBottom:10}}><div style={{fontSize:9,fontWeight:700,color:'#c6a34e',textTransform:'uppercase',letterSpacing:1,marginBottom:4}}>{tText('Base légale')}</div><div style={{fontSize:11,color:'#e8e6e0'}}>{d.base_legale}</div></div>}
