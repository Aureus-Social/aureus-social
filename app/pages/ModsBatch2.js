  ...
  return <div style={{padding:24}}>
    ...
    {tab==='history'&&<div style={sCard}>
      ...
      {historyLoading?<div style={{padding:20,textAlign:'center',color:'#666'}}>{tText('Chargement...')}</div>:
        ...
        <table style={{width:'100%',borderCollapse:'collapse',fontSize:11}}>
          <thead><tr><th style={sTh}>{tText('Date')}</th><th style={sTh}>Format</th><th style={sTh}>{tText('Période')}</th><th style={sTh}>Client</th><th style={sTh}>Lignes</th><th style={sTh}>{tText('Brut')}</th><th style={sTh}>Net</th></tr></thead>
...
export function MarketplaceMod({s,d}){
  ...
  const cats=[{v:'all',l:tText('Tous')},{v:'rh',l:'RH'},{v:'finance',l:'Finance'},{v:'temps',l:'Temps'},{v:'formation',l:'Formation'},{v:'mobilite',l:'Mobilité'},{v:'documents',l:tText('Documents')},{v:'compliance',l:'Compliance'},{v:'analytics',l:tText('Analytics')},{v:'ia',l:'IA'}];
...
export function SchedulerMod({s,d}){
  ...
  const tasks=[
    ...
    {id:'T2',title:'Provisions ONSS',deadline:`${y}-${String(m).padStart(2,'0')}-05`,freq:'Mensuel',cat:tText('ONSS'),status:'done',prio:'haute',auto:true},
    ...
    {id:'T13',title:'Vérification contrats CDD',deadline:`${y}-${String(m).padStart(2,'0')}-01`,freq:'Mensuel',cat:tText('Contrats'),status:'pending',prio:'moyenne',auto:true},
...
export function TemplatesMod({s,d}){
  ...
  const templates=[
    {id:'tpl_cdi',name:tText('Contrat CDI'),cat:'Contrat',icon:'📄',desc:'Contrat à durée indéterminée conforme à la loi du 3/7/1978',fields:[tText('Nom'),tText('Prénom'),'NISS','Fonction','CP',tText('Salaire brut'),'Date début','Lieu de travail','Horaire']},
    {id:'tpl_cdd',name:tText('Contrat CDD'),cat:'Contrat',icon:'📄',desc:'Contrat à durée déterminée — écrit obligatoire AVANT le début',fields:[tText('Nom'),tText('Prénom'),'NISS','Fonction','CP',tText('Salaire brut'),'Date début','Date fin','Motif']},
    {id:'tpl_student',name:'Convention étudiant (COE)',cat:'Contrat',icon:'🎓',desc:'Convention d\'occupation étudiant — mentions obligatoires (Titre VII)',fields:[tText('Nom'),tText('Prénom'),'NISS','Fonction','Salaire horaire','Date début','Date fin','Horaire','École']},
    ...
    {id:'tpl_c4',name:'Formulaire C4',cat:'Sortie',icon:'📋',desc:'Certificat de chômage — obligatoire à la fin du contrat',fields:[tText('Nom'),'NISS','Date entrée','Date sortie','Motif fin','Dernier salaire']},
    {id:'tpl_préavis',name:'Lettre de préavis',cat:'Sortie',icon:'✉️',desc:'Notification de préavis par l\'employeur (recommandé)',fields:['Nom employé',tText('Ancienneté'),'Durée préavis','Date début préavis','Motif']},
    ...
    {id:'tpl_rt',name:tText('Règlement de travail'),cat:'Légal',icon:'📖',desc:'Document obligatoire dès le 1er travailleur (Loi 8/4/1965)',fields:['Horaires','Modes de paiement','Sanctions','Préavis','Premiers secours','CPPT']},
    {id:'tpl_nda',name:tText('Accord de confidentialité'),cat:'Légal',icon:'🔒',desc:'Clause de confidentialité pour données sensibles',fields:['Nom employé','Périmètre','Durée','Sanctions',tText('Date')]},
    ...
    {id:'tpl_expense',name:'Note de frais',cat:'Finance',icon:'🧾',desc:'Formulaire de remboursement de frais professionnels',fields:['Nom employé',tText('Date'),tText('Description'),tText('Montant'),'Justificatif','Catégorie']},
    ...
    <div style={{display:'grid',gridTemplateColumns:'260px 1fr',gap:18}}>
      ...
      <div>
        ...
        {tab==='docs'&&<C>
          ...
          {[{t:'Fiches fiscales 281.10',y:'2025',ic:'📊'},{t:'Attestation de travail',y:'2026',ic:'📋'},{t:tText('Contrat de travail'),y:'2024',ic:'📄'},{t:tText('Règlement de travail'),y:'2026',ic:'📕'},{t:'Attestation pécule vacances',y:'2025',ic:'🏖'},{t:'Fiche accident travail',y:'—',ic:'🏥'}].map((doc,i)=>
