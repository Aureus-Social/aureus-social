...
function genFiche281Html(emp, co, annee, TX_ONSS_W_val, quickPP_fn) {
  ...
  else if(t>8829&&t<=13635) csssAn=r2l((LOIS_BELGES.csss.isole[4].montantFixe+(t-8829)*0.011)*12/3);
  else if(t>13635) csssAn=r2l(LOIS_BELGES.csss.isole[4].montantFixe*3*12/3);
...
function calcFiche281(emp, TX_ONSS_W, quickPP) {
  ...
  const csssAn = (() => {
    ...
    if(t<=13635) return r2((LOIS_BELGES.csss.isole[4].montantFixe+(t-8829)*0.011)*12/3);
    return r2(LOIS_BELGES.csss.isole[4].montantFixe*3*12/3);
  })();
